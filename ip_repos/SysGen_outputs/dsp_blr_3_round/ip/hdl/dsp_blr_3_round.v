...
// Generated from Simulink block dsp_blr_3_round/DBL_Scalar2Vector1/Scalar2Vector
module dsp_blr_3_round_scalar2vector (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DBL_Scalar2Vector1/Vector Reinterpret
module dsp_blr_3_round_vector_reinterpret (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DBL_Scalar2Vector1
module dsp_blr_3_round_dbl_scalar2vector1 (
  input [16-1:0] in1,
  ...
  assign dout_net = in1;
  dsp_blr_3_round_scalar2vector scalar2vector (
    .i(concat_y_net),
    .o_1(slice0_y_net),
    .o_2(slice1_y_net),
    .o_3(slice2_y_net),
  ...
  dsp_blr_3_round_vector_reinterpret vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  sysgen_concat_725ed8d239 concat (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .input_port(dout_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DSP_Vector2Scalar/Vector Slice
module dsp_blr_3_round_vector_slice (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DSP_Vector2Scalar/Vector2Scalar
module dsp_blr_3_round_vector2scalar (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
  ...
  sysgen_concat_725ed8d239 concat1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .in0(slice7_y_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DSP_Vector2Scalar/Vector_reinterpret2unsigned
module dsp_blr_3_round_vector_reinterpret2unsigned (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_e48661a83e reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e48661a83e reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DSP_Vector2Scalar
module dsp_blr_3_round_dsp_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  dsp_blr_3_round_vector_slice vector_slice (
  ...
  dsp_blr_3_round_vector2scalar vector2scalar (
    .i_1(slice0_y_net),
    .i_2(slice1_y_net),
    .i_3(slice2_y_net),
    .i_4(slice3_y_net),
  ...
  dsp_blr_3_round_vector_reinterpret2unsigned vector_reinterpret2unsigned (
    .in_1(addsub0_s_net),
    .in_2(addsub1_s_net),
    .in_3(addsub2_s_net),
    .in_4(addsub3_s_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/DSP_delay
module dsp_blr_3_round_dsp_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/HGAIN_Vector2Scalar/Vector2Scalar
module dsp_blr_3_round_vector2scalar_x0 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/HGAIN_Vector2Scalar/Vector_reinterpret2unsigned
module dsp_blr_3_round_vector_reinterpret2unsigned_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/HGAIN_Vector2Scalar
module dsp_blr_3_round_hgain_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  dsp_blr_3_round_vector2scalar_x0 vector2scalar (
  ...
  dsp_blr_3_round_vector_reinterpret2unsigned_x0 vector_reinterpret2unsigned (
    .in_1(delay0_q_net),
    .in_2(delay1_q_net),
    .in_3(delay2_q_net),
    .in_4(delay3_q_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/HGAIN_delay
module dsp_blr_3_round_hgain_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/Moving Average1
module dsp_blr_3_round_moving_average1 (
  input [128-1:0] tdata_in,
  input clk_1,
  input ce_1,
  output [17-1:0] sum_data_out
);
  wire [17-1:0] shift_op_net;
  wire [128-1:0] concat1_y_net;
  wire clk_net;
  wire ce_net;
  wire [17-1:0] addsub14_s_net;
  wire [18-1:0] shift1_op_net;
  wire [17-1:0] addsub9_s_net;
  wire [16-1:0] reinterpret6_output_port_net;
  wire [17-1:0] addsub10_s_net;
  wire [16-1:0] delay6_q_net;
  wire [19-1:0] shift2_op_net;
  ...
  wire [16-1:0] slice1_y_net;
  wire [16-1:0] slice4_y_net;
  assign sum_data_out = shift_op_net;
  assign concat1_y_net = tdata_in;
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  dsp_blr_3_round_xladdsub #(
    .a_arith(`xlSigned),
    .a_bin_pt(4),
    .a_width(16),
    .b_arith(`xlSigned),
    ...
    .c_latency(0),
    .c_output_width(17),
    .core_name0("dsp_blr_3_round_c_addsub_v12_0_i0"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(0),
  ...
  dsp_blr_3_round_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(18),
    .core_name0("dsp_blr_3_round_c_addsub_v12_0_i1"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(18),
    .latency(0),
  ...
  dsp_blr_3_round_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(20),
    .core_name0("dsp_blr_3_round_c_addsub_v12_0_i2"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(20),
    .latency(0),
  ...
  dsp_blr_3_round_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(19),
    .core_name0("dsp_blr_3_round_c_addsub_v12_0_i3"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(19),
    .latency(0),
  ...
  sysgen_reinterpret_fe264cfc84 reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_shift_ad59b8a413 shift1 (
    .clr(1'b0),
    .ip(addsub4_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  sysgen_shift_2a8962e037 shift2 (
    .clr(1'b0),
    .ip(addsub6_s_net),
    .clk(clk_net),
    .ce(ce_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/Scalar2Vector
module dsp_blr_3_round_scalar2vector_x0 (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/Vector AddSub Fabric2
module dsp_blr_3_round_vector_addsub_fabric2 (
  input [16-1:0] a_1,
  input [16-1:0] b_1,
  input [16-1:0] a_2,
  input [16-1:0] a_3,
  ...
  dsp_blr_3_round_xladdsub #(
    ...
    .c_latency(1),
    .c_output_width(17),
    .core_name0("dsp_blr_3_round_c_addsub_v12_0_i4"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(1),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/Vector Reinterpret
module dsp_blr_3_round_vector_reinterpret_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/Vector Reinterpret2
module dsp_blr_3_round_vector_reinterpret2 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round/Vector2Scalar1
module dsp_blr_3_round_vector2scalar1 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_3_round_struct
module dsp_blr_3_round_struct (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  dsp_blr_3_round_dbl_scalar2vector1 dbl_scalar2vector1 (
    .in1(dout_net),
  ...
  dsp_blr_3_round_dsp_vector2scalar dsp_vector2scalar (
    .in1_1(addsub0_s_net),
    .in1_2(addsub1_s_net),
    .in1_3(addsub2_s_net),
    .in1_4(addsub3_s_net),
  ...
  dsp_blr_3_round_dsp_delay dsp_delay (
  ...
  dsp_blr_3_round_hgain_vector2scalar hgain_vector2scalar (
  ...
  dsp_blr_3_round_hgain_delay hgain_delay (
    .d_1(delay0_q_net),
    .d_2(delay1_q_net),
    .d_3(delay2_q_net),
    .d_4(delay3_q_net),
  ...
  dsp_blr_3_round_moving_average1 moving_average1 (
    .tdata_in(concat1_y_net),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .sum_data_out(shift_op_net)
  );
  dsp_blr_3_round_scalar2vector_x0 scalar2vector (
  ...
  dsp_blr_3_round_vector_addsub_fabric2 vector_addsub_fabric2 (
    .a_1(delay0_q_net),
  ...
  dsp_blr_3_round_vector_reinterpret_x0 vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  dsp_blr_3_round_vector_reinterpret2 vector_reinterpret2 (
  ...
  dsp_blr_3_round_vector2scalar1 vector2scalar1 (
    .i_1(reinterpret0_output_port_net),
    .i_2(reinterpret1_output_port_net),
    .i_3(reinterpret2_output_port_net),
    .i_4(reinterpret3_output_port_net),
  ...
  sysgen_delay_c1cfa03fe9 l_gain_tdata_delay (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_delay_371baa7032 l_gain_tvalid_delay (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
module dsp_blr_3_round_default_clock_driver (
  input dsp_blr_3_round_sysclk,
  input dsp_blr_3_round_sysce,
  input dsp_blr_3_round_sysclr,
  output dsp_blr_3_round_clk1,
  output dsp_blr_3_round_ce1
);
  xlclockdriver #(
    .period(1),
    .log_2_period(1)
  ...
  clockdriver (
    .sysclk(dsp_blr_3_round_sysclk),
    .sysce(dsp_blr_3_round_sysce),
    .sysclr(dsp_blr_3_round_sysclr),
    .clk(dsp_blr_3_round_clk1),
    .ce(dsp_blr_3_round_ce1)
  );
endmodule
`timescale 1 ns / 10 ps
// Generated from Simulink block 
(* core_generation_info = "dsp_blr_3_round,sysgen_core_2019_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu29dr,speed=-1-e,package=ffvf1760,synthesis_language=verilog,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=1,interface_doc=1,ce_clr=0,clock_period=8,system_simulink_period=8e-09,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=0.0001,addsub=23,concat=4,convert=1,delay=27,reinterpret=49,shift=3,slice=32,}" *)
module dsp_blr_3_round (
  input [128-1:0] h_s_axis_tdata,
  input [1-1:0] h_s_axis_tvalid,
  input [32-1:0] l_s_axis_tdata,
  input [1-1:0] l_s_axis_tvalid,
  ...
  wire clk_1_net;
  wire ce_1_net;
  dsp_blr_3_round_default_clock_driver dsp_blr_3_round_default_clock_driver (
    .dsp_blr_3_round_sysclk(clk),
    .dsp_blr_3_round_sysce(1'b1),
    .dsp_blr_3_round_sysclr(1'b0),
    .dsp_blr_3_round_clk1(clk_1_net),
    .dsp_blr_3_round_ce1(ce_1_net)
  );
  dsp_blr_3_round_struct dsp_blr_3_round_struct (
