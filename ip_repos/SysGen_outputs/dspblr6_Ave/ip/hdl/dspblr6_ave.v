...
// Generated from Simulink block dspblr6_Ave/+cut
module dspblr6_ave_cut (
  input [17-1:0] in1,
  input clk_1,
  input ce_1,
  output [17-1:0] out1
  ...
  dspblr6_ave_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(20),
    .core_name0("dspblr6_ave_c_addsub_v12_0_i0"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(20),
    .latency(0),
  ...
  dspblr6_ave_xlmult #(
    ...
    .c_output_width(19),
    .c_type(0),
    .core_name0("dspblr6_ave_mult_gen_v12_0_i0"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  sysgen_shift_0b25837a77 shift7 (
    .clr(1'b0),
    .ip(addsub7_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  sysgen_sgn_89e1a57eda threshold (
    .clr(1'b0),
    .x(addsub14_s_net),
    .clk(clk_net),
    .ce(ce_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/Ave6
module dspblr6_ave_ave6 (
  ...
  dspblr6_ave_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(17),
    .core_name0("dspblr6_ave_c_addsub_v12_0_i1"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(0),
  ...
  dspblr6_ave_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(18),
    .core_name0("dspblr6_ave_c_addsub_v12_0_i2"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(18),
    .latency(0),
  ...
  dspblr6_ave_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(20),
    .core_name0("dspblr6_ave_c_addsub_v12_0_i3"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(20),
    .latency(0),
  ...
  dspblr6_ave_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(19),
    .core_name0("dspblr6_ave_c_addsub_v12_0_i4"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(19),
    .latency(0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_shift_b916eea5f6 shift1 (
    .clr(1'b0),
  ...
  sysgen_shift_b916eea5f6 shift3 (
    .clr(1'b0),
  ...
  sysgen_shift_b916eea5f6 shift5 (
    .clr(1'b0),
  ...
  sysgen_shift_b916eea5f6 shift7 (
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DBL_Scalar2Vector1/Scalar2Vector
module dspblr6_ave_scalar2vector_x0 (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DBL_Scalar2Vector1/Vector Reinterpret
module dspblr6_ave_vector_reinterpret (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_e208f20fee reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_e208f20fee reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DBL_Scalar2Vector1
module dspblr6_ave_dbl_scalar2vector1 (
  input [16-1:0] in1,
  ...
  assign dout_net = in1;
  dspblr6_ave_scalar2vector_x0 scalar2vector (
    .i(concat_y_net),
    .o_1(slice0_y_net),
    .o_2(slice1_y_net),
    .o_3(slice2_y_net),
  ...
  dspblr6_ave_vector_reinterpret vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  sysgen_concat_191dbab135 concat (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .input_port(dout_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DBL_Scalar2Vector2/Scalar2Vector
module dspblr6_ave_scalar2vector (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DBL_Scalar2Vector2/Vector Reinterpret
module dspblr6_ave_vector_reinterpret_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DBL_Scalar2Vector2
module dspblr6_ave_dbl_scalar2vector2 (
  input [16-1:0] in1,
  output [16-1:0] out1_1,
  output [16-1:0] out1_2,
  output [16-1:0] out1_3,
  ...
  dspblr6_ave_scalar2vector scalar2vector (
    .i(concat_y_net),
    .o_1(slice0_y_net),
    .o_2(slice1_y_net),
    .o_3(slice2_y_net),
  ...
  dspblr6_ave_vector_reinterpret_x0 vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DSP_Vector2Scalar/Vector2Scalar
module dspblr6_ave_vector2scalar (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
  ...
  sysgen_concat_191dbab135 concat1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DSP_Vector2Scalar/Vector_reinterpret2unsigned
module dspblr6_ave_vector_reinterpret2unsigned (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_79294c23b4 reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_79294c23b4 reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DSP_Vector2Scalar
module dspblr6_ave_dsp_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  dspblr6_ave_vector2scalar vector2scalar (
  ...
  dspblr6_ave_vector_reinterpret2unsigned vector_reinterpret2unsigned (
    .in_1(addsub0_s_net),
    .in_2(addsub1_s_net),
    .in_3(addsub2_s_net),
    .in_4(addsub3_s_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/DSP_delay
module dspblr6_ave_dsp_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/HGAIN_Vector2Scalar/Vector2Scalar
module dspblr6_ave_vector2scalar_x0 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/HGAIN_Vector2Scalar/Vector_reinterpret2unsigned
module dspblr6_ave_vector_reinterpret2unsigned_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/HGAIN_Vector2Scalar
module dspblr6_ave_hgain_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  dspblr6_ave_vector2scalar_x0 vector2scalar (
    .i_1(reinterpret0_output_port_net),
    .i_2(reinterpret1_output_port_net),
    .i_3(reinterpret2_output_port_net),
    .i_4(reinterpret3_output_port_net),
  ...
  dspblr6_ave_vector_reinterpret2unsigned_x0 vector_reinterpret2unsigned (
    .in_1(delay0_q_net),
    .in_2(delay1_q_net),
    .in_3(delay2_q_net),
    .in_4(delay3_q_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/HGAIN_delay
module dspblr6_ave_hgain_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/Scalar2Vector
module dspblr6_ave_scalar2vector_x1 (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/Vector AddSub Fabric2
module dspblr6_ave_vector_addsub_fabric2 (
  input [16-1:0] a_1,
  input [16-1:0] b_1,
  input [16-1:0] a_2,
  input [16-1:0] a_3,
  ...
  dspblr6_ave_xladdsub #(
    ...
    .c_latency(1),
    .c_output_width(17),
    .core_name0("dspblr6_ave_c_addsub_v12_0_i5"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(1),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/Vector Reinterpret
module dspblr6_ave_vector_reinterpret_x1 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/Vector Reinterpret2
module dspblr6_ave_vector_reinterpret2 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave/Vector2Scalar1
module dspblr6_ave_vector2scalar1 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dspblr6_Ave_struct
module dspblr6_ave_struct (
  ...
  dspblr6_ave_ave6 ave6 (
    .tdata_in(concat1_y_net_x1),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .sum_data_out(addsub14_s_net)
  );
  dspblr6_ave_dbl_scalar2vector1 dbl_scalar2vector1 (
    .in1(dout_net),
  ...
  dspblr6_ave_dbl_scalar2vector2 dbl_scalar2vector2 (
    .in1(constant_op_net),
  ...
  dspblr6_ave_dsp_vector2scalar dsp_vector2scalar (
    .in1_1(addsub0_s_net),
    .in1_2(addsub1_s_net),
    .in1_3(addsub2_s_net),
    .in1_4(addsub3_s_net),
  ...
  dspblr6_ave_dsp_delay dsp_delay (
  ...
  dspblr6_ave_hgain_vector2scalar hgain_vector2scalar (
    .in1_1(delay0_q_net),
    .in1_2(delay1_q_net),
    .in1_3(delay2_q_net),
  ...
  dspblr6_ave_hgain_delay hgain_delay (
    .d_1(delay0_q_net_x0),
    .d_2(delay1_q_net_x0),
    .d_3(delay2_q_net_x0),
    .d_4(delay3_q_net),
  ...
  dspblr6_ave_scalar2vector_x1 scalar2vector (
  ...
  dspblr6_ave_vector_addsub_fabric2 vector_addsub_fabric2 (
  ...
  dspblr6_ave_vector_reinterpret_x1 vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  dspblr6_ave_vector_reinterpret2 vector_reinterpret2 (
  ...
  dspblr6_ave_vector2scalar1 vector2scalar1 (
  ...
  sysgen_constant_b6aa6a2f05 constant (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .op(constant_op_net)
  ...
  sysgen_delay_9a0823591f l_gain_tdata_delay (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_delay_f8f9a6cbbe l_gain_tvalid_delay (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
module dspblr6_ave_default_clock_driver (
  input dspblr6_ave_sysclk,
  input dspblr6_ave_sysce,
  input dspblr6_ave_sysclr,
  output dspblr6_ave_clk1,
  output dspblr6_ave_ce1
);
  xlclockdriver #(
    .period(1),
    .log_2_period(1)
...
module dspblr6_ave (
  ...
  wire ce_1_net;
  wire clk_1_net;
  dspblr6_ave_default_clock_driver dspblr6_ave_default_clock_driver (
    .dspblr6_ave_sysclk(clk),
    .dspblr6_ave_sysce(1'b1),
    .dspblr6_ave_sysclr(1'b0),
    .dspblr6_ave_clk1(clk_1_net),
    .dspblr6_ave_ce1(ce_1_net)
  );
  dspblr6_ave_struct dspblr6_ave_struct (
