...
// Generated from Simulink block simple_dsp_module/8sample_average /Vector_sum/Vector Reinterpret
module simple_dsp_module_vector_reinterpret (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_2e11a5155c reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/8sample_average /Vector_sum/Vector2Scalar
module simple_dsp_module_vector2scalar (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
  ...
  sysgen_concat_1221d5c9f7 concat1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/8sample_average /Vector_sum
module simple_dsp_module_vector_sum (
  ...
  assign ce_net = ce_1;
  simple_dsp_module_vector_reinterpret vector_reinterpret (
  ...
  simple_dsp_module_vector2scalar vector2scalar (
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(17),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i0"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(0),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(18),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i1"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(18),
    .latency(0),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(19),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i2"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(19),
    .latency(0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/8sample_average /scaling
module simple_dsp_module_scaling (
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/8sample_average 
module simple_dsp_module_8sample_average (
  input [1-1:0] valid_in,
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  simple_dsp_module_vector_sum vector_sum (
  ...
  simple_dsp_module_scaling scaling (
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DBL_Scalar2Vector/Scalar2Vector
module simple_dsp_module_scalar2vector (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DBL_Scalar2Vector/Vector Reinterpret
module simple_dsp_module_vector_reinterpret_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_45d55ecbc1 reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DBL_Scalar2Vector
module simple_dsp_module_dbl_scalar2vector (
  input [16-1:0] in1,
  ...
  simple_dsp_module_scalar2vector scalar2vector (
    .i(concat_y_net),
    .o_1(slice0_y_net),
    .o_2(slice1_y_net),
    .o_3(slice2_y_net),
  ...
  simple_dsp_module_vector_reinterpret_x0 vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  sysgen_concat_1221d5c9f7 concat (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_2e11a5155c reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DSP_Vector2Scalar/Vector2Scalar
module simple_dsp_module_vector2scalar_x0 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DSP_Vector2Scalar/Vector_reinterpret2unsigned
module simple_dsp_module_vector_reinterpret2unsigned (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DSP_Vector2Scalar
module simple_dsp_module_dsp_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  simple_dsp_module_vector2scalar_x0 vector2scalar (
    .i_1(reinterpret0_output_port_net),
  ...
  simple_dsp_module_vector_reinterpret2unsigned vector_reinterpret2unsigned (
    .in_1(addsub0_s_net),
    .in_2(addsub1_s_net),
    .in_3(addsub2_s_net),
    .in_4(addsub3_s_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/DSP_delay
module simple_dsp_module_dsp_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/HGAIN_Vector2Scalar/Vector2Scalar
module simple_dsp_module_vector2scalar_x1 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/HGAIN_Vector2Scalar/Vector_reinterpret2unsigned
module simple_dsp_module_vector_reinterpret2unsigned_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/HGAIN_Vector2Scalar
module simple_dsp_module_hgain_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  simple_dsp_module_vector2scalar_x1 vector2scalar (
    .i_1(reinterpret0_output_port_net),
    .i_2(reinterpret1_output_port_net),
    .i_3(reinterpret2_output_port_net),
    .i_4(reinterpret3_output_port_net),
  ...
  simple_dsp_module_vector_reinterpret2unsigned_x0 vector_reinterpret2unsigned (
    .in_1(delay0_q_net),
    .in_2(delay1_q_net),
    .in_3(delay2_q_net),
    .in_4(delay3_q_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/HGAIN_delay
module simple_dsp_module_hgain_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/Scalar2Vector
module simple_dsp_module_scalar2vector_x0 (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/Vector AddSub Fabric
module simple_dsp_module_vector_addsub_fabric (
  input [16-1:0] a_1,
  input [16-1:0] b_1,
  input [16-1:0] a_2,
  input [16-1:0] a_3,
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(1),
    .c_output_width(17),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i3"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(1),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/Vector Reinterpret
module simple_dsp_module_vector_reinterpret_x1 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/xil_dac_PID
module simple_dsp_module_xil_dac_pid (
  input [1-1:0] valid_in,
  ...
  simple_dsp_module_xlmult #(
    ...
    .c_output_width(48),
    .c_type(0),
    .core_name0("simple_dsp_module_mult_gen_v12_0_i0"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  sysgen_accum_65a68633b7 accumulator (
    .clr(1'b0),
  ...
  sysgen_constant_4cf6c9391e i_dt (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .op(i_dt_op_net)
  );
  sysgen_inverter_9355411c35 inverter (
    .clr(1'b0),
  ...
  sysgen_logical_5a019e3573 logical (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .d0(inverter_op_net),
  ...
  simple_dsp_module_xlmult #(
    ...
    .c_output_width(36),
    .c_type(0),
    .core_name0("simple_dsp_module_mult_gen_v12_0_i1"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(49),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i4"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(49),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/xil_dac_delta_calc
module simple_dsp_module_xil_dac_delta_calc (
  input [1-1:0] valid_in,
  input [19-1:0] data_in,
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  sysgen_constant_acba946d69 constant (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .op(constant_op_net)
  );
  sysgen_logical_75b30515b9 logical (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(20),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i5"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(20),
    .latency(0),
  ...
  sysgen_relational_56fa687b43 isnot_undershoot (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .a(shift_op_net),
  ...
  sysgen_relational_eb6769c3da no_operation (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/xil_dac_smoothing
module simple_dsp_module_xil_dac_smoothing (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  sysgen_shift_ce2cc87a73 x2sample_ave (
    .clr(1'b0),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(50),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i6"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(50),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/xil_dblc_PID
module simple_dsp_module_xil_dblc_pid (
  input [1-1:0] valid_in,
  ...
  sysgen_accum_63d8a07e86 accumulator (
    .clr(1'b0),
    .b(delta_from_baseline_s_net),
    .rst(logical_y_net_x0),
    .clk(clk_net),
  ...
  simple_dsp_module_xlmult #(
    ...
    .c_output_width(37),
    .c_type(0),
    .core_name0("simple_dsp_module_mult_gen_v12_0_i2"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/xil_dblc_delta_calc
module simple_dsp_module_xil_dblc_delta_calc (
  input [1-1:0] valid_in,
  input [19-1:0] data_in,
  ...
  sysgen_logical_8f99cd5115 logical (
    .clr(1'b0),
    .d0(isnot_undershoot_op_net),
    .d1(no_operation_op_net),
    .clk(clk_net),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(21),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i7"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(21),
    .latency(0),
  ...
  simple_dsp_module_xladdsub #(
    ...
    .c_latency(1),
    .c_output_width(20),
    .core_name0("simple_dsp_module_c_addsub_v12_0_i8"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(20),
    .latency(1),
  ...
  sysgen_relational_e080d4f0e4 no_operation (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module/xil_dblc_smoothing
module simple_dsp_module_xil_dblc_smoothing (
  input [49-1:0] data_in,
  input clk_1,
  input ce_1,
  output [50-1:0] data_out
...
`timescale 1 ns / 10 ps
// Generated from Simulink block simple_dsp_module_struct
module simple_dsp_module_struct (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  simple_dsp_module_8sample_average x8sample_average (
    .valid_in(h_s_axis_tvalid_net),
  ...
  simple_dsp_module_dbl_scalar2vector dbl_scalar2vector (
  ...
  simple_dsp_module_dsp_vector2scalar dsp_vector2scalar (
    .in1_1(addsub0_s_net),
    .in1_2(addsub1_s_net),
    .in1_3(addsub2_s_net),
    .in1_4(addsub3_s_net),
  ...
  simple_dsp_module_dsp_delay dsp_delay (
  ...
  simple_dsp_module_hgain_vector2scalar hgain_vector2scalar (
    .in1_1(delay0_q_net),
    .in1_2(delay1_q_net),
    .in1_3(delay2_q_net),
    .in1_4(delay3_q_net),
  ...
  simple_dsp_module_hgain_delay hgain_delay (
    .d_1(delay0_q_net_x0),
    .d_2(delay1_q_net_x0),
    .d_3(delay2_q_net_x0),
    .d_4(delay3_q_net_x0),
  ...
  simple_dsp_module_scalar2vector_x0 scalar2vector (
  ...
  simple_dsp_module_vector_addsub_fabric vector_addsub_fabric (
    .a_1(delay0_q_net_x0),
  ...
  simple_dsp_module_vector_reinterpret_x1 vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  simple_dsp_module_xil_dac_pid xil_dac_pid (
  ...
  simple_dsp_module_xil_dac_delta_calc xil_dac_delta_calc (
    .valid_in(tvalid_delay_q_net),
  ...
  simple_dsp_module_xil_dac_smoothing xil_dac_smoothing (
    .data_in(p_comp_i_comp_s_net_x0),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .data_out(x2sample_ave_op_net_x0)
  );
  simple_dsp_module_xil_dblc_pid xil_dblc_pid (
    .valid_in(tvalid_delay_q_net),
  ...
  simple_dsp_module_xil_dblc_delta_calc xil_dblc_delta_calc (
    .valid_in(tvalid_delay_q_net),
    .data_in(shift_op_net),
  ...
  simple_dsp_module_xil_dblc_smoothing xil_dblc_smoothing (
    .data_in(p_comp_i_comp_s_net),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .data_out(x2sample_ave_op_net)
  );
  simple_dsp_module_xlconvert #(
    .bool_conversion(0),
    .din_arith(2),
    .din_bin_pt(0),
    .din_width(13),
...
module simple_dsp_module_default_clock_driver (
  input simple_dsp_module_sysclk,
  input simple_dsp_module_sysce,
  input simple_dsp_module_sysclr,
  output simple_dsp_module_clk1,
  output simple_dsp_module_ce1
);
  xlclockdriver #(
    .period(1),
    .log_2_period(1)
  ...
  clockdriver (
    .sysclk(simple_dsp_module_sysclk),
    .sysce(simple_dsp_module_sysce),
    .sysclr(simple_dsp_module_sysclr),
    .clk(simple_dsp_module_clk1),
    .ce(simple_dsp_module_ce1)
  );
endmodule
`timescale 1 ns / 10 ps
// Generated from Simulink block 
...
module simple_dsp_module (
  ...
  wire clk_1_net;
  wire ce_1_net;
  simple_dsp_module_default_clock_driver simple_dsp_module_default_clock_driver (
    .simple_dsp_module_sysclk(clk),
    .simple_dsp_module_sysce(1'b1),
    .simple_dsp_module_sysclr(1'b0),
    .simple_dsp_module_clk1(clk_1_net),
    .simple_dsp_module_ce1(ce_1_net)
  );
  simple_dsp_module_struct simple_dsp_module_struct (
