...
// Generated from Simulink block dsp_blr_9/+cut
module dsp_blr_9_cut (
  input [17-1:0] in1,
  input clk_1,
  input ce_1,
  output [17-1:0] out1
  ...
  dsp_blr_9_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(20),
    .core_name0("dsp_blr_9_c_addsub_v12_0_i0"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(20),
    .latency(0),
  ...
  dsp_blr_9_xlmult #(
    ...
    .c_output_width(19),
    .c_type(0),
    .core_name0("dsp_blr_9_mult_gen_v12_0_i0"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  sysgen_shift_1e9b85835c shift7 (
    .clr(1'b0),
    .ip(addsub7_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  sysgen_sgn_d03a3e7538 threshold (
    .clr(1'b0),
    .x(addsub15_s_net),
    .clk(clk_net),
    .ce(ce_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Ave9/Subsystem
module dsp_blr_9_subsystem (
  input [16-1:0] in1,
  input clk_1,
  input ce_1,
  output [18-1:0] out1
  ...
  dsp_blr_9_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(17),
    .core_name0("dsp_blr_9_c_addsub_v12_0_i3"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(0),
  ...
  dsp_blr_9_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(18),
    .core_name0("dsp_blr_9_c_addsub_v12_0_i2"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(18),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Ave9/Subsystem1
module dsp_blr_9_subsystem1 (
  input [16-1:0] in1,
  input clk_1,
  input ce_1,
  output [18-1:0] out1
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Ave9/Subsystem2
module dsp_blr_9_subsystem2 (
  input [16-1:0] in1,
  input clk_1,
  input ce_1,
  output [18-1:0] out1
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Ave9/Subsystem3
module dsp_blr_9_subsystem3 (
  input [16-1:0] in1,
  input clk_1,
  input ce_1,
  output [18-1:0] out1
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Ave9
module dsp_blr_9_ave9 (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  dsp_blr_9_subsystem subsystem (
    .in1(shift7_op_net),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .out1(addsub4_s_net)
  );
  dsp_blr_9_subsystem1 subsystem1 (
    .in1(shift5_op_net),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .out1(addsub4_s_net_x0)
  );
  dsp_blr_9_subsystem2 subsystem2 (
    .in1(shift1_op_net),
    .clk_1(clk_net),
    .ce_1(ce_net),
    .out1(addsub4_s_net_x1)
  );
  dsp_blr_9_subsystem3 subsystem3 (
    .in1(shift3_op_net),
    .clk_1(clk_net),
    .ce_1(ce_net),
  ...
  dsp_blr_9_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(19),
    .core_name0("dsp_blr_9_c_addsub_v12_0_i1"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(19),
    .latency(0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_shift_f12b3ced8e shift1 (
    .clr(1'b0),
  ...
  sysgen_shift_f12b3ced8e shift3 (
    .clr(1'b0),
  ...
  sysgen_shift_f12b3ced8e shift5 (
    .clr(1'b0),
  ...
  sysgen_shift_f12b3ced8e shift7 (
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DBL_Scalar2Vector1/Scalar2Vector
module dsp_blr_9_scalar2vector (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DBL_Scalar2Vector1/Vector Reinterpret
module dsp_blr_9_vector_reinterpret (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_14a8106724 reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_14a8106724 reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DBL_Scalar2Vector1
module dsp_blr_9_dbl_scalar2vector1 (
  input [16-1:0] in1,
  ...
  assign dout_net = in1;
  dsp_blr_9_scalar2vector scalar2vector (
    .i(concat_y_net),
    .o_1(slice0_y_net),
    .o_2(slice1_y_net),
    .o_3(slice2_y_net),
  ...
  dsp_blr_9_vector_reinterpret vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  sysgen_concat_374fb9b5b2 concat (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .input_port(dout_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DSP_Vector2Scalar/Vector2Scalar
module dsp_blr_9_vector2scalar (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
  ...
  sysgen_concat_374fb9b5b2 concat1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DSP_Vector2Scalar/Vector_reinterpret2unsigned
module dsp_blr_9_vector_reinterpret2unsigned (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret0 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret6 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_reinterpret_bfdbfe6424 reinterpret7 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DSP_Vector2Scalar
module dsp_blr_9_dsp_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  dsp_blr_9_vector2scalar vector2scalar (
  ...
  dsp_blr_9_vector_reinterpret2unsigned vector_reinterpret2unsigned (
    .in_1(addsub0_s_net),
    .in_2(addsub1_s_net),
    .in_3(addsub2_s_net),
    .in_4(addsub3_s_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/DSP_delay
module dsp_blr_9_dsp_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/HGAIN_Vector2Scalar/Vector2Scalar
module dsp_blr_9_vector2scalar_x0 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/HGAIN_Vector2Scalar/Vector_reinterpret2unsigned
module dsp_blr_9_vector_reinterpret2unsigned_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/HGAIN_Vector2Scalar
module dsp_blr_9_hgain_vector2scalar (
  input [16-1:0] in1_1,
  input [16-1:0] in1_2,
  input [16-1:0] in1_3,
  input [16-1:0] in1_4,
  ...
  dsp_blr_9_vector2scalar_x0 vector2scalar (
    .i_1(reinterpret0_output_port_net),
    .i_2(reinterpret1_output_port_net),
    .i_3(reinterpret2_output_port_net),
    .i_4(reinterpret3_output_port_net),
  ...
  dsp_blr_9_vector_reinterpret2unsigned_x0 vector_reinterpret2unsigned (
    .in_1(delay0_q_net),
    .in_2(delay1_q_net),
    .in_3(delay2_q_net),
    .in_4(delay3_q_net),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/HGAIN_delay
module dsp_blr_9_hgain_delay (
  input [16-1:0] d_1,
  input [16-1:0] d_2,
  input [16-1:0] d_3,
  input [16-1:0] d_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Scalar2Vector
module dsp_blr_9_scalar2vector_x0 (
  input [128-1:0] i,
  output [16-1:0] o_1,
  output [16-1:0] o_2,
  output [16-1:0] o_3,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Vector AddSub Fabric2
module dsp_blr_9_vector_addsub_fabric2 (
  input [16-1:0] a_1,
  input [16-1:0] b_1,
  input [16-1:0] a_2,
  input [16-1:0] a_3,
  ...
  dsp_blr_9_xladdsub #(
    ...
    .c_latency(1),
    .c_output_width(17),
    .core_name0("dsp_blr_9_c_addsub_v12_0_i4"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(17),
    .latency(1),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Vector Reinterpret
module dsp_blr_9_vector_reinterpret_x0 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Vector Reinterpret2
module dsp_blr_9_vector_reinterpret2 (
  input [16-1:0] in_1,
  input [16-1:0] in_2,
  input [16-1:0] in_3,
  input [16-1:0] in_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9/Vector2Scalar1
module dsp_blr_9_vector2scalar1 (
  input [16-1:0] i_1,
  input [16-1:0] i_2,
  input [16-1:0] i_3,
  input [16-1:0] i_4,
...
`timescale 1 ns / 10 ps
// Generated from Simulink block dsp_blr_9_struct
module dsp_blr_9_struct (
  ...
  dsp_blr_9_dbl_scalar2vector1 dbl_scalar2vector1 (
    .in1(dout_net),
  ...
  dsp_blr_9_dsp_vector2scalar dsp_vector2scalar (
    .in1_1(addsub0_s_net),
    .in1_2(addsub1_s_net),
    .in1_3(addsub2_s_net),
    .in1_4(addsub3_s_net),
  ...
  dsp_blr_9_hgain_vector2scalar hgain_vector2scalar (
  ...
  dsp_blr_9_hgain_delay hgain_delay (
    .d_1(delay0_q_net),
    .d_2(delay1_q_net),
    .d_3(delay2_q_net_x0),
    .d_4(delay3_q_net_x0),
  ...
  dsp_blr_9_scalar2vector_x0 scalar2vector (
  ...
  dsp_blr_9_vector_addsub_fabric2 vector_addsub_fabric2 (
    .a_1(delay0_q_net),
  ...
  dsp_blr_9_vector_reinterpret_x0 vector_reinterpret (
    .in_1(slice0_y_net),
    .in_2(slice1_y_net),
    .in_3(slice2_y_net),
    .in_4(slice3_y_net),
  ...
  dsp_blr_9_vector_reinterpret2 vector_reinterpret2 (
  ...
  dsp_blr_9_vector2scalar1 vector2scalar1 (
    .i_1(reinterpret0_output_port_net),
    .i_2(reinterpret1_output_port_net),
    .i_3(reinterpret2_output_port_net),
    .i_4(reinterpret3_output_port_net),
  ...
  sysgen_delay_eb5b68f4b9 l_gain_tdata_delay (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
  ...
  sysgen_delay_b15157b99c l_gain_tvalid_delay (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
...
module dsp_blr_9_default_clock_driver (
  input dsp_blr_9_sysclk,
  input dsp_blr_9_sysce,
  input dsp_blr_9_sysclr,
  output dsp_blr_9_clk1,
  output dsp_blr_9_ce1
);
  xlclockdriver #(
    .period(1),
    .log_2_period(1)
  ...
  clockdriver (
    .sysclk(dsp_blr_9_sysclk),
    .sysce(dsp_blr_9_sysce),
    .sysclr(dsp_blr_9_sysclr),
    .clk(dsp_blr_9_clk1),
    .ce(dsp_blr_9_ce1)
  );
endmodule
...
module dsp_blr_9 (
  ...
  wire clk_1_net;
  wire ce_1_net;
  dsp_blr_9_default_clock_driver dsp_blr_9_default_clock_driver (
    .dsp_blr_9_sysclk(clk),
    .dsp_blr_9_sysce(1'b1),
    .dsp_blr_9_sysclr(1'b0),
    .dsp_blr_9_clk1(clk_1_net),
    .dsp_blr_9_ce1(ce_1_net)
  );
  dsp_blr_9_struct dsp_blr_9_struct (
