...
#
# MMT_SGDMA_test.tcl: Tcl script for re-creating project 'MMT_SGDMA_test'
#
# Generated by Vivado on Wed Feb 19 10:34:39 +0900 2020
...
#
# 1. This project restoration tcl script (MMT_SGDMA_test.tcl) that was generated.
#
...
#    "C:/Users/MoGURA/KRD/project_tcl/ZCU111/MMT_SGDMA_test/design_1_wrapper.v"
#    "C:/Users/MoGURA/KRD/project_tcl/ZCU111/MMT_SGDMA_test/MMT_SGDMA_test_PinAssign.xdc"
#    "C:/Users/MoGURA/KRD/project_tcl/ZCU111/MMT_SGDMA_test/MMT_SGDMA_test_Timing.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "MMT_SGDMA_test"
...
set script_file "MMT_SGDMA_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/MMT_SGDMA_test"]"
...
set file "[file normalize "$origin_dir/MMT_SGDMA_test_PinAssign.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/MMT_SGDMA_test_PinAssign.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/MMT_SGDMA_test_Timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/MMT_SGDMA_test_Timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# led_chika
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  www.awa.tohoku.co.jp:jj1and:EASYHS_AXIS_converter:1.0\
  ...
  set EASYHS_AXIS_converter_0 [ create_bd_cell -type ip -vlnv www.awa.tohoku.co.jp:jj1and:EASYHS_AXIS_converter:1.0 EASYHS_AXIS_converter_0 ]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] [get_bd_pins /EASYHS_AXIS_converter_0/RESET]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_SG] [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  ...
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins system_ila_1/probe0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins EASYHS_AXIS_converter_0/CLK] [get_bd_pins MinimumTrigger_0/RD_CLK] [get_bd_pins MinimumTrigger_1/RD_CLK] [get_bd_pins TwoChMixer_0/CLK] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins led_chika_0/CLK] [get_bd_pins rst_mmtrg_128M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  ...
  connect_bd_net -net rst_mmtrg_250M_peripheral_aresetn [get_bd_pins axi_smc_1/aresetn] [get_bd_pins led_chika_0/RESETN] [get_bd_pins rst_mmtrg_128M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins pre_acqui_len_gpio/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins reset_gpio/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_1/resetn] [get_bd_pins threshold_basline_gpio/s_axi_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins pre_acqui_len_gpio/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins reset_gpio/s_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_1/clk] [get_bd_pins threshold_basline_gpio/s_axi_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP0_DDR_HIGH
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HP1_DDR_HIGH
  ...
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_SG/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
