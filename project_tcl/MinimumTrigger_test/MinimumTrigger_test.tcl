...
#
# MinimumTrigger_test.tcl: Tcl script for re-creating project 'MinimumTrigger_test'
#
# Generated by Vivado on Tue Dec 24 14:32:27 +0900 2019
...
#
# 1. This project restoration tcl script (MinimumTrigger_test.tcl) that was generated.
#
...
#
#    "C:/Users/MoGURA/Desktop/Zynq_dev/KRD/common_source/led_chika.v"
#    "C:/Users/MoGURA/Desktop/Zynq_dev/KRD/project_tcl/MinimumTrigger_test/design_1_wrapper.v"
#    "C:/Users/MoGURA/Desktop/Zynq_dev/KRD/project_tcl/MinimumTrigger_test/MinimumTrigger_test.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "MinimumTrigger_test"
...
set script_file "MinimumTrigger_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../ZCU111/MinimumTrigger_test"]"
...
set file "[file normalize "$origin_dir/MinimumTrigger_test.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/MinimumTrigger_test.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/MinimumTrigger_test.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/MinimumTrigger_test.xdc"]" -objects $obj
...
if { [get_files led_chika.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/MoGURA/Desktop/Zynq_dev/KRD/common_source/led_chika.v
}
...
# led_chika
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:jj1and:MinimumTrigger:1.2\
  ...
  # Create ports
  set CH0_EXT_READY [ create_bd_port -dir I CH0_EXT_READY ]
  set CH0_TRG_VALID [ create_bd_port -dir O CH0_TRG_VALID ]
  set CH1_EXT_READY [ create_bd_port -dir I CH1_EXT_READY ]
  set CH1_TRG_VALID [ create_bd_port -dir O CH1_TRG_VALID ]
  ...
  set MinimumTrigger_0 [ create_bd_cell -type ip -vlnv xilinx.com:jj1and:MinimumTrigger:1.2 MinimumTrigger_0 ]

  # Create instance: MinimumTrigger_1, and set properties
  set MinimumTrigger_1 [ create_bd_cell -type ip -vlnv xilinx.com:jj1and:MinimumTrigger:1.2 MinimumTrigger_1 ]
  set_property -dict [ list \
   CONFIG.CHANNEL_ID {1} \
 ] $MinimumTrigger_1

  # Create instance: baseline, and set properties
  set baseline [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 baseline ]
  set_property -dict [ list \
  ...
  # Create instance: pre_acqui_len, and set properties
  set pre_acqui_len [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pre_acqui_len ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {5} \
  ...
  # Create instance: theshold_val, and set properties
  set theshold_val [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 theshold_val ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0x0400} \
  ...
  connect_bd_net -net CH0_EXT_READY_1 [get_bd_ports CH0_EXT_READY] [get_bd_pins MinimumTrigger_0/iREADY]
  connect_bd_net -net CH1_EXT_READY_1 [get_bd_ports CH1_EXT_READY] [get_bd_pins MinimumTrigger_1/iREADY]
  connect_bd_net -net MinimumTrigger_0_oVALID [get_bd_ports CH0_TRG_VALID] [get_bd_pins MinimumTrigger_0/oVALID]
  connect_bd_net -net MinimumTrigger_1_oVALID [get_bd_ports CH1_TRG_VALID] [get_bd_pins MinimumTrigger_1/oVALID]
  connect_bd_net -net baseline_dout [get_bd_pins MinimumTrigger_0/BASELINE] [get_bd_pins MinimumTrigger_1/BASELINE] [get_bd_pins baseline/dout]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins MinimumTrigger_0/RD_CLK] [get_bd_pins MinimumTrigger_1/RD_CLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins led_chika_0/CLK] [get_bd_pins rst_mmtrg_250M/slowest_sync_clk]
  ...
  connect_bd_net -net pre_acqui_len_dout [get_bd_pins MinimumTrigger_0/PRE_ACQUIASION_LEN] [get_bd_pins MinimumTrigger_1/PRE_ACQUIASION_LEN] [get_bd_pins pre_acqui_len/dout]
  connect_bd_net -net rst_mmtrg_250M_peripheral_aresetn [get_bd_pins MinimumTrigger_0/RD_RESETN] [get_bd_pins MinimumTrigger_1/RD_RESETN] [get_bd_pins led_chika_0/RESETN] [get_bd_pins rst_mmtrg_250M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net theshold_val_dout [get_bd_pins MinimumTrigger_0/THRESHOLD_VAL] [get_bd_pins MinimumTrigger_1/THRESHOLD_VAL] [get_bd_pins theshold_val/dout]
...
#  -string -flagsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x 0 -y 490 -defaultsOSRD
preplace port adc0_clk -pg 1 -lvl 0 -x 0 -y 470 -defaultsOSRD
preplace port vin0_01 -pg 1 -lvl 0 -x 0 -y 700 -defaultsOSRD
preplace port CLK_IN1_D_0 -pg 1 -lvl 0 -x 0 -y 780 -defaultsOSRD
preplace port vin0_23 -pg 1 -lvl 0 -x 0 -y 860 -defaultsOSRD
preplace port CH1_TRG_VALID -pg 1 -lvl 5 -x 1890 -y 590 -defaultsOSRD
preplace port CH0_TRG_VALID -pg 1 -lvl 5 -x 1890 -y 850 -defaultsOSRD
preplace port locked_0 -pg 1 -lvl 5 -x 1890 -y 1330 -defaultsOSRD
preplace port LED_OUT_0 -pg 1 -lvl 5 -x 1890 -y 1080 -defaultsOSRD
preplace port CH1_EXT_READY -pg 1 -lvl 0 -x 0 -y 200 -defaultsOSRD
preplace port CH0_EXT_READY -pg 1 -lvl 0 -x 0 -y 1010 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 300 -defaultsOSRD
preplace inst usp_rf_data_converter_0 -pg 1 -lvl 3 -x 1270 -y 530 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 850 -y 330 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 330 -y 100 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 330 -y 780 -defaultsOSRD
preplace inst rst_mmtrg_500M -pg 1 -lvl 2 -x 850 -y 600 -defaultsOSRD
preplace inst rst_mmtrg_250M -pg 1 -lvl 3 -x 1270 -y 910 -defaultsOSRD
preplace inst time_counter -pg 1 -lvl 3 -x 1270 -y 740 -defaultsOSRD
preplace inst theshold_val -pg 1 -lvl 3 -x 1270 -y 1270 -defaultsOSRD
preplace inst baseline -pg 1 -lvl 3 -x 1270 -y 1070 -defaultsOSRD
preplace inst pre_acqui_len -pg 1 -lvl 3 -x 1270 -y 1170 -defaultsOSRD
preplace inst MinimumTrigger_0 -pg 1 -lvl 4 -x 1690 -y 860 -defaultsOSRD
preplace inst MinimumTrigger_1 -pg 1 -lvl 4 -x 1690 -y 600 -defaultsOSRD
preplace inst led_chika_0 -pg 1 -lvl 4 -x 1690 -y 1080 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 210 670 210 1080
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 3 30 390 640 470 1040J
preplace netloc rst_ps8_0_96M_peripheral_aresetn 1 1 2 660 200 1090
preplace netloc clk_wiz_0_clk_out1 1 1 3 660 450 1070 390 1490
preplace netloc clk_wiz_0_clk_out2 1 1 3 N 780 1030 810 1460
preplace netloc rst_mmtrg_500M_peripheral_aresetn 1 2 2 1100 670 1500
preplace netloc rst_mmtrg_250M_peripheral_aresetn 1 3 1 1470 600n
preplace netloc clk_wiz_0_locked 1 1 4 NJ 800 1020J 1330 NJ 1330 NJ
preplace netloc led_chika_0_LED_OUT 1 4 1 NJ 1080
preplace netloc rst_mmtrg_500M_peripheral_reset 1 2 1 1020 600n
preplace netloc pre_acqui_len_dout 1 3 1 1440 620n
preplace netloc theshold_val_dout 1 3 1 1510 640n
preplace netloc baseline_dout 1 3 1 1450 660n
preplace netloc time_counter_Q 1 3 1 1520 680n
preplace netloc MinimumTrigger_0_oVALID 1 4 1 1870J 850n
preplace netloc MinimumTrigger_1_oVALID 1 4 1 1870J 590n
preplace netloc CH1_EXT_READY_1 1 0 5 NJ 200 640J 190 NJ 190 NJ 190 1860
preplace netloc CH0_EXT_READY_1 1 0 5 NJ 1010 NJ 1010 NJ 1010 NJ 1010 1860
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 1100 330n
preplace netloc usp_rf_data_converter_0_m00_axis 1 3 1 1480 500n
preplace netloc adc0_clk_1 1 0 3 NJ 470 630J 460 1100J
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 1 1 N 270
preplace netloc CLK_IN1_D_0_1 1 0 1 NJ 780
preplace netloc usp_rf_data_converter_0_m02_axis 1 3 1 N 520
preplace netloc sysref_in_1 1 0 3 NJ 490 650J 480 1060J
preplace netloc vin0_01_1 1 0 3 20J 690 670J 490 NJ
preplace netloc vin0_23_0_1 1 0 3 30J 700 680J 500 1050J
levelinfo -pg 1 0 330 850 1270 1690 1890
pagesize -pg 1 -db -bbox -sgen -180 0 2060 1350
"
}
...
if {[string equal [get_runs -quiet synth_3] ""]} {
    create_run -name synth_3 -part xczu28dr-ffvg1517-2-e -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs synth_3]
  set_property flow "Vivado Synthesis 2019" [get_runs synth_3]
}
