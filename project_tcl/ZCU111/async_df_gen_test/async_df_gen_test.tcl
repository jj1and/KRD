...
#
# async_df_gen_test.tcl: Tcl script for re-creating project 'async_df_gen_test'
#
# Generated by Vivado on Thu Oct 22 20:08:43 +0900 2020
...
#
# 1. This project restoration tcl script (async_df_gen_test.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "E:/KRD/project_tcl/ZCU111/async_df_gen_test/async_df_gen_test/async_df_gen_test.srcs/sim_1/imports/async_datafram_generator/test_dataframe_gen_pkg.sv"
#    "E:/KRD/project_tcl/ZCU111/async_df_gen_test/async_df_gen_test/async_df_gen_test.srcs/sim_1/imports/async_datafram_generator/async_df_gen_test_tb.sv"
#
...
#    "E:/KRD/project_tcl/ZCU111/async_df_gen_test/design_1_wrapper.v"
#    "E:/KRD/project_tcl/ZCU111/async_df_gen_test/sim_design_wrapper.v"
#    "E:/KRD/project_tcl/ZCU111/async_df_gen_test/async_df_gen_PinAssign.xdc"
#    "E:/KRD/project_tcl/ZCU111/async_df_gen_test/async_df_gen_test_tb_behav.wcfg"
#
#*****************************************************************************************
...
set _xil_proj_name_ "async_df_gen_test"
...
set script_file "async_df_gen_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/async_df_gen_test"]"
...
set file "[file normalize "$origin_dir/async_df_gen_PinAssign.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/async_df_gen_PinAssign.xdc"
set file [file normalize $file]
...
set files [list \
 [file normalize "${origin_dir}/async_df_gen_test_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/async_df_gen_test/async_df_gen_test.srcs/sim_1/imports/async_datafram_generator/test_dataframe_gen_pkg.sv"]\
 [file normalize "${origin_dir}/async_df_gen_test/async_df_gen_test.srcs/sim_1/imports/async_datafram_generator/async_df_gen_test_tb.sv"]\
]
set imported_files [import_files -fileset sim_1 $files]

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/async_df_gen_test_tb_behav.wcfg"
set file [file normalize $file]
...
set file "async_datafram_generator/test_dataframe_gen_pkg.sv"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
...
set file "async_datafram_generator/async_df_gen_test_tb.sv"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "async_df_gen_test_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# async_dataframe_generator
  ...
  set CLK_LOCKED_LED1 [ create_bd_port -dir O CLK_LOCKED_LED1 ]
  set DATAFRAME_GEN_ERROR_0 [ create_bd_port -dir O DATAFRAME_GEN_ERROR_0 ]
  set EXT_RESET [ create_bd_port -dir I -type rst EXT_RESET ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $EXT_RESET
  set RESET_LED [ create_bd_port -dir O -from 0 -to 0 RESET_LED ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {333.25} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {158.899} \
   CONFIG.CLKOUT1_PHASE_ERROR {271.786} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {333.25} \
  ...
  # Create instance: config_gpio, and set properties
  set config_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 config_gpio ]
  set_property -dict [ list \
  ...
  # Create instance: inverse_active_state, and set properties
  set inverse_active_state [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 inverse_active_state ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
   CONFIG.LOGO_FILE {data/sym_notgate.png} \
 ] $inverse_active_state
  ...
  # Create instance: reset_indicate_or, and set properties
  set reset_indicate_or [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 reset_indicate_or ]
  set_property -dict [ list \
  ...
  # Create instance: rst_clk_wiz_125MHz, and set properties
  set rst_clk_wiz_125MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_125MHz ]

  # Create instance: rst_clk_wiz_333M, and set properties
  set rst_clk_wiz_333M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_333M ]
  ...
  connect_bd_intf_net -intf_net async_dataframe_gene_0_M_AXIS [get_bd_intf_pins async_dataframe_gene_0/M_AXIS] [get_bd_intf_pins axis_clock_converter_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets async_dataframe_gene_0_M_AXIS] [get_bd_intf_pins async_dataframe_gene_0/M_AXIS] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets async_dataframe_gene_0_M_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clock_converter_0_M_AXIS] [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_clock_converter_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins async_dataframe_gene_0/S_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS1 [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net default_sysclk1_300mhz_1 [get_bd_intf_ports default_sysclk1_300mhz] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins config_gpio/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net EXT_RESET_1 [get_bd_ports EXT_RESET] [get_bd_pins reset_indicate_or/Op2] [get_bd_pins rst_clk_wiz_125MHz/aux_reset_in] [get_bd_pins rst_clk_wiz_333M/aux_reset_in]
  connect_bd_net -net async_dataframe_gene_0_DATAFRAME_GEN_ERROR [get_bd_ports DATAFRAME_GEN_ERROR_0] [get_bd_pins async_dataframe_gene_0/DATAFRAME_GEN_ERROR] [get_bd_pins system_ila_1/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets async_dataframe_gene_0_DATAFRAME_GEN_ERROR]
  ...
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins async_dataframe_gene_0/S_AXIS_TDATA] [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins system_ila_0/SLOT_0_AXIS_tdata] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins async_dataframe_gene_0/M_AXIS_ACLK] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rst_clk_wiz_333M/slowest_sync_clk] [get_bd_pins system_ila_1/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports CLK_LOCKED_LED1] [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_333M/dcm_locked]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins async_dataframe_gene_0/S_AXIS_ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins config_gpio/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_125MHz/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  connect_bd_net -net clk_wiz_locked [get_bd_ports CLK_LOCKED_LED] [get_bd_pins clk_wiz/locked] [get_bd_pins rst_clk_wiz_125MHz/dcm_locked]
  connect_bd_net -net config_gpio_gpio2_io_o [get_bd_pins async_dataframe_gene_0/MAX_TRIGGER_LENGTH] [get_bd_pins config_gpio/gpio2_io_o] [get_bd_pins system_ila_0/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets config_gpio_gpio2_io_o]
  connect_bd_net -net config_gpio_gpio_io_o [get_bd_pins async_dataframe_gene_0/SET_CONFIG] [get_bd_pins config_gpio/gpio_io_o] [get_bd_pins system_ila_0/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets config_gpio_gpio_io_o]
  connect_bd_net -net inverse_active_state_Res [get_bd_pins inverse_active_state/Res] [get_bd_pins reset_indicate_or/Op1]
  connect_bd_net -net reset_indicate_or_Res [get_bd_ports RESET_LED] [get_bd_pins reset_indicate_or/Res]
  connect_bd_net -net rst_clk_wiz_125MHz_interconnect_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_clk_wiz_125MHz/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_125MHz_peripheral_aresetn [get_bd_pins async_dataframe_gene_0/S_AXIS_RESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins config_gpio/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_125MHz/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net rst_clk_wiz_125MHz_peripheral_reset [get_bd_pins rst_clk_wiz_125MHz/peripheral_reset] [get_bd_pins system_ila_0/probe4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets rst_clk_wiz_125MHz_peripheral_reset]
  connect_bd_net -net rst_clk_wiz_333M_peripheral_aresetn [get_bd_pins async_dataframe_gene_0/M_AXIS_RESETN] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins rst_clk_wiz_333M/peripheral_aresetn] [get_bd_pins system_ila_1/resetn]
  connect_bd_net -net rst_clk_wiz_333M_peripheral_reset [get_bd_pins rst_clk_wiz_333M/peripheral_reset]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins async_dataframe_gene_0/H_GAIN_TDATA] [get_bd_pins system_ila_0/probe5] [get_bd_pins xlslice_0/Dout]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets xlslice_0_Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins inverse_active_state/Op1] [get_bd_pins rst_clk_wiz_125MHz/ext_reset_in] [get_bd_pins rst_clk_wiz_333M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs config_gpio/S_AXI/Reg] SEG_config_gpio_Reg
...
#  -string -flagsOSRD
preplace port CLK_IN1_D_0 -pg 1 -lvl 0 -x -1 -y 530 -defaultsOSRD
preplace port default_sysclk1_300mhz -pg 1 -lvl 0 -x -1 -y 840 -defaultsOSRD
preplace port CLK_LOCKED_LED -pg 1 -lvl 11 -x 3880 -y 910 -defaultsOSRD
preplace port DATAFRAME_GEN_ERROR_0 -pg 1 -lvl 11 -x 3880 -y 610 -defaultsOSRD
preplace port EXT_RESET -pg 1 -lvl 0 -x -1 -y 710 -defaultsOSRD
preplace port CLK_LOCKED_LED1 -pg 1 -lvl 11 -x 3880 -y 990 -defaultsOSRD
preplace portBus RESET_LED -pg 1 -lvl 11 -x 3880 -y 800 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 6 -x 2200 -y 140 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 830 -y 260 -defaultsOSRD
preplace inst axis_dwidth_converter_0 -pg 1 -lvl 7 -x 2550 -y 530 -defaultsOSRD
preplace inst clk_wiz -pg 1 -lvl 1 -x 129 -y 530 -defaultsOSRD
preplace inst config_gpio -pg 1 -lvl 6 -x 2200 -y 360 -defaultsOSRD
preplace inst inverse_active_state -pg 1 -lvl 8 -x 2850 -y 810 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 5 -x 1813 -y 300 -defaultsOSRD
preplace inst reset_indicate_or -pg 1 -lvl 9 -x 3350 -y 910 -defaultsOSRD
preplace inst rst_clk_wiz_125MHz -pg 1 -lvl 2 -x 449 -y 590 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 3 -x 830 -y 100 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 4 -x 1310 -y 290 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 8 -x 2850 -y 580 -defaultsOSRD
preplace inst axis_dwidth_converter_1 -pg 1 -lvl 5 -x 1813 -y 540 -defaultsOSRD
preplace inst axis_data_fifo_1 -pg 1 -lvl 4 -x 1310 -y 570 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 8 -x 2850 -y 390 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 9 -x 3350 -y 380 -defaultsOSRD
preplace inst axis_clock_converter_0 -pg 1 -lvl 3 -x 830 -y 550 -defaultsOSRD
preplace inst rst_clk_wiz_333M -pg 1 -lvl 2 -x 449 -y 810 -defaultsOSRD
preplace inst system_ila_1 -pg 1 -lvl 10 -x 3750 -y 520 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 129 -y 840 -defaultsOSRD
preplace inst async_dataframe_gene_0 -pg 1 -lvl 9 -x 3350 -y 710 -defaultsOSRD
preplace netloc EXT_RESET_1 1 0 9 NJ 710 250 920 NJ 920 NJ 920 NJ 920 NJ 920 NJ 920 NJ 920 NJ
preplace netloc axi_dma_0_mm2s_introut 1 2 7 690 170 NJ 170 1620J 160 2030J 260 2390 280 NJ 280 3040J
preplace netloc axi_dma_0_s2mm_introut 1 2 7 680 440 NJ 440 NJ 440 1980J 460 2370 290 NJ 290 3070J
preplace netloc clk_wiz_clk_out1 1 1 8 270 490 640 350 990 470 1650 140 2020 480 2440 450 2670 460 3030
preplace netloc clk_wiz_locked 1 1 10 240 690 620J 670 NJ 670 NJ 670 NJ 670 NJ 670 2660J 660 3100J 570 3600J 620 3860
preplace netloc config_gpio_gpio2_io_o 1 6 3 2410 330 NJ 330 3050
preplace netloc config_gpio_gpio_io_o 1 6 3 2390 320 NJ 320 3060
preplace netloc inverse_active_state_Res 1 8 1 3070J 810n
preplace netloc reset_indicate_or_Res 1 9 2 NJ 910 3850
preplace netloc rst_clk_wiz_125MHz_interconnect_aresetn 1 2 1 620 290n
preplace netloc rst_clk_wiz_125MHz_peripheral_aresetn 1 2 7 680 650 1000 650 1630 150 2010 270 2380 610 2680J 670 3020
preplace netloc rst_clk_wiz_125MHz_peripheral_reset 1 2 7 630 450 970J 460 NJ 460 1970J 470 2430J 440 2680J 450 3080
preplace netloc xlconcat_0_dout 1 3 1 1000 100n
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 7 270 700 NJ 700 NJ 700 1620 810 NJ 810 NJ 810 NJ
preplace netloc xlslice_0_Dout 1 8 1 3040 390n
preplace netloc axis_data_fifo_0_m_axis_tdata 1 7 2 2680 310 3110
preplace netloc async_dataframe_gene_0_DATAFRAME_GEN_ERROR 1 9 2 3610J 610 N
preplace netloc rst_clk_wiz_333M_peripheral_aresetn 1 2 8 650 690 N 690 N 690 N 690 N 690 N 690 3010 560 3600
preplace netloc rst_clk_wiz_333M_peripheral_reset 1 2 1 N 810
preplace netloc clk_wiz_0_clk_out1 1 1 9 260 710 660J 680 NJ 680 NJ 680 NJ 680 NJ 680 NJ 680 3120J 550 3580
preplace netloc clk_wiz_0_locked 1 1 10 240 990 NJ 990 NJ 990 NJ 990 NJ 990 NJ 990 NJ 990 NJ 990 NJ 990 NJ
preplace netloc default_sysclk1_300mhz_1 1 0 1 N 840
preplace netloc ps8_0_axi_periph_M00_AXI 1 5 1 1970 90n
preplace netloc axis_data_fifo_0_M_AXIS 1 8 1 3090 280n
preplace netloc axis_data_fifo_1_M_AXIS 1 4 1 1660 520n
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 5 660 10 NJ 10 NJ 10 NJ 10 2380
preplace netloc axis_clock_converter_0_M_AXIS 1 3 6 980 450 N 450 N 450 2400 300 N 300 3080
preplace netloc axi_smc_M00_AXI 1 3 1 N 260
preplace netloc axis_dwidth_converter_1_M_AXIS 1 5 1 1990 110n
preplace netloc CLK_IN1_D_0_1 1 0 1 NJ 530
preplace netloc async_dataframe_gene_0_M_AXIS 1 2 8 650 0 NJ 0 NJ 0 NJ 0 NJ 0 NJ 0 NJ 0 3590
preplace netloc axi_dma_0_M_AXIS_MM2S 1 6 1 2420 120n
preplace netloc axi_dma_0_M_AXI_S2MM 1 2 5 670 20 NJ 20 NJ 20 NJ 20 2370
preplace netloc axis_dwidth_converter_0_M_AXIS1 1 7 1 2660 530n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 4 1 1640 220n
preplace netloc ps8_0_axi_periph_M01_AXI 1 5 1 2000 310n
levelinfo -pg 1 -1 129 449 830 1310 1813 2200 2550 2850 3350 3750 3880
pagesize -pg 1 -db -bbox -sgen -210 -10 4140 1100
"
}
...
# async_dataframe_generator
  ...
  # Create port connections
  connect_bd_net -net CLK_125MHZ_1 [get_bd_ports CLK_125MHZ] [get_bd_pins async_dataframe_gene_0/S_AXIS_ACLK] [get_bd_pins rst_CLK_125MHZ_125M/slowest_sync_clk]
  connect_bd_net -net CLK_333MHZ_1 [get_bd_ports CLK_333MHZ] [get_bd_pins async_dataframe_gene_0/M_AXIS_ACLK] [get_bd_pins rst_CLK_333MHZ_333M/slowest_sync_clk]
  ...
  connect_bd_net -net MAX_TRIGGER_LENGTH_0_1 [get_bd_ports MAX_TRIGGER_LENGTH] [get_bd_pins async_dataframe_gene_0/MAX_TRIGGER_LENGTH]
  connect_bd_net -net M_AXIS_TREADY_0_1 [get_bd_ports M_AXIS_TREADY] [get_bd_pins async_dataframe_gene_0/M_AXIS_TREADY]
  connect_bd_net -net SET_CONFIG_0_1 [get_bd_ports SET_CONFIG] [get_bd_pins async_dataframe_gene_0/SET_CONFIG]
  ...
  connect_bd_net -net async_dataframe_gene_0_M_AXIS_TDATA [get_bd_ports M_AXIS_TDATA] [get_bd_pins async_dataframe_gene_0/M_AXIS_TDATA]
  connect_bd_net -net async_dataframe_gene_0_M_AXIS_TKEEP [get_bd_ports M_AXIS_TKEEP] [get_bd_pins async_dataframe_gene_0/M_AXIS_TKEEP]
  connect_bd_net -net async_dataframe_gene_0_M_AXIS_TLAST [get_bd_ports M_AXIS_TLAST] [get_bd_pins async_dataframe_gene_0/M_AXIS_TLAST]
  connect_bd_net -net async_dataframe_gene_0_M_AXIS_TVALID [get_bd_ports M_AXIS_TVALID] [get_bd_pins async_dataframe_gene_0/M_AXIS_TVALID]
  ...
  connect_bd_net -net rst_CLK_333MHZ_333M_peripheral_aresetn [get_bd_pins async_dataframe_gene_0/M_AXIS_RESETN] [get_bd_pins rst_CLK_333MHZ_333M/peripheral_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "guistr":"# # String gsaved with Nlview 7.0.19  2019-03-26 bk=1.5019 VDI=41 GEI=35 GUI=JA:9.0 non-TLS
#  -string -flagsOSRD
preplace port CLK_125MHZ -pg 1 -lvl 0 -x 0 -y 20 -defaultsOSRD
preplace port CLK_333MHZ -pg 1 -lvl 0 -x 0 -y 250 -defaultsOSRD
preplace port DATAFRAME_GEN_ERROR -pg 1 -lvl 3 -x 870 -y 520 -defaultsOSRD
preplace port EXT_RESET -pg 1 -lvl 0 -x 0 -y 90 -defaultsOSRD
preplace port SET_CONFIG -pg 1 -lvl 0 -x 0 -y 510 -defaultsOSRD
preplace port S_AXIS_TVALID -pg 1 -lvl 0 -x 0 -y 410 -defaultsOSRD
preplace port M_AXIS_TLAST -pg 1 -lvl 3 -x 870 -y 460 -defaultsOSRD
preplace port M_AXIS_TVALID -pg 1 -lvl 3 -x 870 -y 480 -defaultsOSRD
preplace port M_AXIS_TREADY -pg 1 -lvl 0 -x 0 -y 650 -defaultsOSRD
preplace portBus MAX_TRIGGER_LENGTH -pg 1 -lvl 0 -x 0 -y 530 -defaultsOSRD
preplace portBus S_AXIS_TDATA -pg 1 -lvl 0 -x 0 -y 550 -defaultsOSRD
preplace portBus M_AXIS_TDATA -pg 1 -lvl 3 -x 870 -y 420 -defaultsOSRD
preplace portBus M_AXIS_TKEEP -pg 1 -lvl 3 -x 870 -y 440 -defaultsOSRD
preplace inst rst_CLK_333MHZ_333M -pg 1 -lvl 1 -x 200 -y 290 -defaultsOSRD
preplace inst rst_CLK_125MHZ_125M -pg 1 -lvl 1 -x 200 -y 110 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 1 -x 200 -y 590 -defaultsOSRD
preplace inst async_dataframe_gene_0 -pg 1 -lvl 2 -x 620 -y 460 -defaultsOSRD
preplace netloc async_dataframe_gene_0_DATAFRAME_GEN_ERROR 1 2 1 NJ 520
preplace netloc CLK_333MHZ_1 1 0 2 20 470 NJ
preplace netloc rst_CLK_333MHZ_333M_peripheral_aresetn 1 1 1 370 330n
preplace netloc CLK_125MHZ_1 1 0 2 30 10 390J
preplace netloc rst_CLK_125MHZ_125M_peripheral_aresetn 1 1 1 380 150n
preplace netloc EXT_RESET_1 1 0 1 30 90n
preplace netloc MAX_TRIGGER_LENGTH_0_1 1 0 2 NJ 530 NJ
preplace netloc SET_CONFIG_0_1 1 0 2 NJ 510 NJ
preplace netloc S_AXIS_TDATA_0_1 1 0 2 30 390 NJ
preplace netloc S_AXIS_TVALID_0_1 1 0 2 NJ 410 NJ
preplace netloc xlslice_0_Dout 1 1 1 380J 550n
preplace netloc async_dataframe_gene_0_M_AXIS_TDATA 1 2 1 NJ 420
preplace netloc async_dataframe_gene_0_M_AXIS_TKEEP 1 2 1 NJ 440
preplace netloc async_dataframe_gene_0_M_AXIS_TLAST 1 2 1 NJ 460
preplace netloc async_dataframe_gene_0_M_AXIS_TVALID 1 2 1 NJ 480
preplace netloc M_AXIS_TREADY_0_1 1 0 3 NJ 650 NJ 650 850
levelinfo -pg 1 0 200 620 870
pagesize -pg 1 -db -bbox -sgen -260 0 1110 670
"
}
