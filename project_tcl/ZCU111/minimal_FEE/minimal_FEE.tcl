...
#
# Generated by Vivado on Wed Aug 26 22:52:51 +0900 2020
...
# module references:
# data_trigger, dataframe_generator, passthrough_dsp, pl_ddr_mmu
...
proc create_hier_cell_channel_0 { parentCell nameHier } {
  ...
  # Create instance: rst_clk_adc0_122M88Hz, and set properties
  set rst_clk_adc0_122M88Hz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_adc0_122M88Hz ]
  set_property -dict [ list \
   CONFIG.RESET_BOARD_INTERFACE {Custom} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $rst_clk_adc0_122M88Hz
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins channel_0/M_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_intf_net -intf_net channel_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins channel_0/M_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  # Create port connections
  connect_bd_net -net EXT_RESET_1 [get_bd_ports EXT_RESET] [get_bd_ports RESET_LED] [get_bd_pins rst_clk_adc0_122M88Hz/aux_reset_in] [get_bd_pins rst_clk_wiz_0_100MHz/aux_reset_in]
  ...
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins system_ila_0/probe0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  ...
  connect_bd_net -net rst_clk_wiz_0_125MHz_interconnect_aresetn [get_bd_pins rst_clk_adc0_122M88Hz/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_clk_wiz_0_125MHz_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins channel_0/m_axi_s2mm_aresetn] [get_bd_pins fee_controler/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rst_clk_adc0_122M88Hz/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn]
  connect_bd_net -net rst_clk_wiz_0_125MHz_peripheral_reset [get_bd_pins c_counter_binary_0/SCLR] [get_bd_pins channel_0/ARESET] [get_bd_pins ddr4_0/sys_rst] [get_bd_pins rst_clk_adc0_122M88Hz/peripheral_reset]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins channel_0/m_axi_s2mm_aclk] [get_bd_pins fee_controler/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rst_clk_adc0_122M88Hz/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins usp_rf_data_converter_0/clk_adc0] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_clk_adc0_122M88Hz/ext_reset_in] [get_bd_pins rst_clk_wiz_0_100MHz/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
