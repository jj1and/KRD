...
#
# Generated by Vivado on Wed Sep 02 15:24:45 +0900 2020
...
proc create_hier_cell_channel_0 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 S2MM_STS_S_AXIS
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_datamover_0_M_AXIS_S2MM_STS] [get_bd_intf_pins S2MM_STS_S_AXIS] [get_bd_intf_pins axi_datamover_0/M_AXIS_S2MM_STS]
  ...
  connect_bd_net -net axi_datamover_0_s2mm_wr_xfer_cmplt [get_bd_pins axi_datamover_0/s2mm_wr_xfer_cmplt]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_8_AXI_AW_SEL_DATA {1} \
   CONFIG.C_SLOT_8_AXI_AW_SEL_TRIG {1} \
   CONFIG.C_SLOT_8_AXI_B_SEL_DATA {1} \
   CONFIG.C_SLOT_8_AXI_B_SEL_TRIG {1} \
   CONFIG.C_SLOT_8_AXI_DATA_SEL {1} \
   CONFIG.C_SLOT_8_AXI_R_SEL_DATA {1} \
   CONFIG.C_SLOT_8_AXI_R_SEL_TRIG {1} \
   CONFIG.C_SLOT_8_AXI_TRIG_SEL {1} \
   CONFIG.C_SLOT_8_AXI_W_SEL_DATA {1} \
   CONFIG.C_SLOT_8_AXI_W_SEL_TRIG {1} \
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins channel_0/M_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins channel_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins channel_0/S_AXIS_MM2S_CMD] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins channel_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins channel_0/S_AXIS_S2MM_CMD] [get_bd_intf_pins system_ila_0/SLOT_6_AXIS]
connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins channel_0/S2MM_STS_S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_7_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_8_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_connector_0_M_AXIS] [get_bd_intf_pins axi_dma_connector_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_9_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets channel_0_M_AXIS] [get_bd_intf_pins channel_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets channel_0_M_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins axi_dma_connector_0/AXIDMA_S2MM_INTR_IN] [get_bd_pins system_ila_0/probe0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  ...
  connect_bd_net -net rst_clk_wiz_0_125MHz_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins channel_0/m_axi_s2mm_aresetn] [get_bd_pins fee_controler/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rst_clk_adc0_122MHz88/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_connector_0/ACLK] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins channel_0/m_axi_s2mm_aclk] [get_bd_pins fee_controler/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rst_clk_adc0_122MHz88/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins usp_rf_data_converter_0/clk_adc0] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
