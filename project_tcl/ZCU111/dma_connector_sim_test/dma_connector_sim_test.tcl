...
#
# dma_connector_sim_test.tcl: Tcl script for re-creating project 'dma_connector_sim_test'
#
# Generated by Vivado on Fri Dec 04 15:57:46 +0900 2020
...
#
# 1. This project restoration tcl script (dma_connector_sim_test.tcl) that was generated.
#
...
#    "E:/KRD/proto_ip_code/axi_dma_connector/axi_dma_connector_tb.sv"
#    "E:/KRD/project_tcl/ZCU111/dma_connector_sim_test/axi_dma_connector_tb_behav.wcfg"
#
#*****************************************************************************************
...
set _xil_proj_name_ "dma_connector_sim_test"
...
set script_file "dma_connector_sim_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/dma_connector_sim_test"]"
...
set_property -name "top" -value "axi_dma_connector" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../../../proto_ip_code/axi_dma_connector/axi_dma_connector_tb.sv"] \
 [file normalize "${origin_dir}/axi_dma_connector_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../../../proto_ip_code/axi_dma_connector/axi_dma_connector_tb.sv"
set file [file normalize $file]
...
set file "$origin_dir/axi_dma_connector_tb_behav.wcfg"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "axi_dma_connector_tb" -objects $obj
