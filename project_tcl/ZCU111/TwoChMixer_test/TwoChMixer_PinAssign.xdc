...
set_property IOSTANDARD LVCMOS18 [get_ports MIXER_VALID] 
set_property PACKAGE_PIN AR13 [get_ports MIXER_VALID] 
...
set_property PACKAGE_PIN AF16 [get_ports EXT_READY]
set_property IOSTANDARD LVCMOS18 [get_ports EXT_READY]
