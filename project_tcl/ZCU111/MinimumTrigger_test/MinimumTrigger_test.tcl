...
#
# Generated by Vivado on Fri Jan 17 13:12:53 +0900 2020
...
# led_chika
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {0b000000000000} \
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {0b0010000000000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.mADC_Decimation_Mode00 {1} \
   CONFIG.mADC_Decimation_Mode01 {1} \
   CONFIG.mADC_Decimation_Mode02 {1} \
   CONFIG.mADC_Decimation_Mode03 {1} \
   CONFIG.mADC_Enable {1} \
   CONFIG.mADC_Fabric_Freq {500.000} \
   CONFIG.mADC_Mixer_Type00 {0} \
   CONFIG.mADC_Mixer_Type01 {0} \
   CONFIG.mADC_Mixer_Type02 {0} \
   CONFIG.mADC_Mixer_Type03 {0} \
   CONFIG.mADC_Outclk_Freq {31.250} \
   CONFIG.mADC_PLL_Enable {false} \
   CONFIG.mADC_Refclk_Freq {4000.000} \
   CONFIG.mADC_Sampling_Rate {4.0} \
   CONFIG.mADC_Slice00_Enable {true} \
   CONFIG.mADC_Slice01_Enable {true} \
   CONFIG.mADC_Slice02_Enable {true} \
   CONFIG.mADC_Slice03_Enable {true} \
  ...
  connect_bd_net -net rst_mmtrg_250M_peripheral_reset [get_bd_pins MinimumTrigger_0/RD_RESET] [get_bd_pins MinimumTrigger_1/RD_RESET] [get_bd_pins rst_mmtrg_250M/peripheral_reset]
