...
#
# pl_ddr_mmu_sim_test.tcl: Tcl script for re-creating project 'pl_ddr_mmu_sim_test'
#
# Generated by Vivado on Mon Jul 27 18:49:29 +0900 2020
...
#
# 1. This project restoration tcl script (pl_ddr_mmu_sim_test.tcl) that was generated.
#
...
#    "E:/KRD/project_tcl/ZCU111/pl_ddr_mmu_sim_test/ddr_sim_wrapper.v"
#    "E:/KRD/project_tcl/ZCU111/pl_ddr_mmu_sim_test/ddr_sim_tb.sv"
#    "E:/KRD/project_tcl/ZCU111/pl_ddr_mmu_sim_test/ddr_sim_tb_behav.wcfg"
#
#*****************************************************************************************
...
set _xil_proj_name_ "pl_ddr_mmu_sim_test"
...
set script_file "pl_ddr_mmu_sim_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/pl_ddr_mmu_sim_test"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/ddr_sim_wrapper.v"] \
]
...
set file "$origin_dir/ddr_sim_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "ddr_sim_wrapper" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/ddr_sim_tb.sv"] \
 [file normalize "${origin_dir}/ddr_sim_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/ddr_sim_tb.sv"
set file [file normalize $file]
...
set file "$origin_dir/ddr_sim_tb_behav.wcfg"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "ddr_sim_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# Proc to create BD ddr_sim
proc cr_bd_ddr_sim { parentCell } {
...
# pl_ddr_mmu
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {EXT_RESET} \
   CONFIG.FREQ_HZ {125000000} \
 ] $CLK
  set DATAMOVER_ERROR_0 [ create_bd_port -dir O DATAMOVER_ERROR_0 ]
  set EXT_RESET [ create_bd_port -dir I -type rst EXT_RESET ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] $EXT_RESET
  set MAX_TRIGGER_LENGTH_0 [ create_bd_port -dir I -from 15 -to 0 MAX_TRIGGER_LENGTH_0 ]
  set SET_CONFIG_0 [ create_bd_port -dir I SET_CONFIG_0 ]
  ...
  connect_bd_intf_net -intf_net S_AXIS_0_1 [get_bd_intf_ports S_AXIS_0] [get_bd_intf_pins pl_ddr_mmu_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net pl_ddr_mmu_0_M_AXIS [get_bd_intf_ports M_AXIS_0] [get_bd_intf_pins pl_ddr_mmu_0/M_AXIS]
  ...
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins axi_datamover_0/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_0/m_axi_s2mm_aclk] [get_bd_pins axi_datamover_0/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_awclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins pl_ddr_mmu_0/ACLK] [get_bd_pins rst_CLK_125M/slowest_sync_clk]
  connect_bd_net -net MAX_TRIGGER_LENGTH_0_1 [get_bd_ports MAX_TRIGGER_LENGTH_0] [get_bd_pins pl_ddr_mmu_0/MAX_TRIGGER_LENGTH]
  connect_bd_net -net SET_CONFIG_0_1 [get_bd_ports SET_CONFIG_0] [get_bd_pins pl_ddr_mmu_0/SET_CONFIG]
  ...
  connect_bd_net -net pl_ddr_mmu_0_DATAMOVER_ERROR [get_bd_ports DATAMOVER_ERROR_0] [get_bd_pins pl_ddr_mmu_0/DATAMOVER_ERROR]
  connect_bd_net -net reset_1 [get_bd_ports EXT_RESET] [get_bd_pins axi_datamover_0/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins rst_CLK_125M/ext_reset_in]
  connect_bd_net -net rst_CLK_125M_peripheral_aresetn [get_bd_pins axi_datamover_0/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_0/m_axi_s2mm_aresetn] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins rst_CLK_125M/peripheral_aresetn]
  connect_bd_net -net rst_CLK_125M_peripheral_reset [get_bd_pins pl_ddr_mmu_0/ARESET] [get_bd_pins rst_CLK_125M/peripheral_reset]
...
#  -string -flagsOSRD
preplace port M_AXIS_0 -pg 1 -lvl 4 -x 1350 -y 130 -defaultsOSRD
preplace port S_AXIS_0 -pg 1 -lvl 0 -x 0 -y 80 -defaultsOSRD
preplace port CLK -pg 1 -lvl 0 -x 0 -y 640 -defaultsOSRD
preplace port EXT_RESET -pg 1 -lvl 0 -x 0 -y 660 -defaultsOSRD
preplace port SET_CONFIG_0 -pg 1 -lvl 0 -x 0 -y 140 -defaultsOSRD
preplace port DATAMOVER_ERROR_0 -pg 1 -lvl 4 -x 1350 -y 190 -defaultsOSRD
preplace portBus MAX_TRIGGER_LENGTH_0 -pg 1 -lvl 0 -x 0 -y 160 -defaultsOSRD
preplace inst axi_datamover_0 -pg 1 -lvl 2 -x 610 -y 540 -defaultsOSRD
preplace inst axi_vip_0 -pg 1 -lvl 3 -x 1090 -y 410 -defaultsOSRD
preplace inst rst_CLK_125M -pg 1 -lvl 1 -x 200 -y 760 -defaultsOSRD
preplace inst pl_ddr_mmu_0 -pg 1 -lvl 3 -x 1090 -y 150 -defaultsOSRD
preplace netloc CLK_1 1 0 3 30 640 380 290 850
preplace netloc MAX_TRIGGER_LENGTH_0_1 1 0 3 NJ 160 NJ 160 NJ
preplace netloc SET_CONFIG_0_1 1 0 3 NJ 140 NJ 140 NJ
preplace netloc axi_datamover_0_s2mm_wr_xfer_cmplt 1 2 1 830 180n
preplace netloc reset_1 1 0 2 20 660 410
preplace netloc rst_CLK_125M_peripheral_aresetn 1 1 2 400 760 870J
preplace netloc rst_CLK_125M_peripheral_reset 1 1 2 370 120 NJ
preplace netloc pl_ddr_mmu_0_DATAMOVER_ERROR 1 3 1 NJ 190
preplace netloc axi_datamover_0_mm2s_rd_xfer_cmplt 1 2 1 820 200n
preplace netloc axi_datamover_0_s2mm_err 1 2 1 860 220n
preplace netloc axi_datamover_0_mm2s_err 1 2 1 840 240n
preplace netloc S_AXIS_0_1 1 0 3 NJ 80 NJ 80 NJ
preplace netloc axi_datamover_0_M_AXI 1 2 1 N 390
preplace netloc pl_ddr_mmu_0_MM2S_CMD_M_AXIS 1 1 3 390 300 NJ 300 1320
preplace netloc pl_ddr_mmu_0_S2MM_CMD_M_AXIS 1 1 3 410 320 NJ 320 1330
preplace netloc pl_ddr_mmu_0_M_AXIS 1 3 1 NJ 130
preplace netloc pl_ddr_mmu_0_S2MM_M_AXIS 1 1 3 400 310 NJ 310 1310
preplace netloc axi_datamover_0_M_AXIS_MM2S 1 2 1 810 60n
levelinfo -pg 1 0 200 610 1090 1350
pagesize -pg 1 -db -bbox -sgen -280 0 1570 860
"
}
...
# End of cr_bd_ddr_sim()
cr_bd_ddr_sim ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files ddr_sim.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files ddr_sim.bd ] 
set_property IS_ENABLED "1" [get_files ddr_sim.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files ddr_sim.bd ] 
set_property IS_LOCKED "0" [get_files ddr_sim.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files ddr_sim.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files ddr_sim.bd ] 
set_property PFM_NAME "" [get_files ddr_sim.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files ddr_sim.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ddr_sim.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files ddr_sim.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files ddr_sim.bd ] 
set_property USED_IN_SIMULATION "1" [get_files ddr_sim.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files ddr_sim.bd ] 
