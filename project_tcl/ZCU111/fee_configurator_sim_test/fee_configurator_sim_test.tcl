...
#
# Generated by Vivado on Sun Jul 26 19:30:25 +0900 2020
...
#
#    "E:/npart/KRD/proto_ip_code/fee_configurator/fee_config.vh"
#    "E:/npart/KRD/proto_ip_code/fee_configurator/fee_configrator.v"
#    "E:/npart/KRD/project_tcl/ZCU111/fee_configurator_sim_test/fee_cfg_sim_wrapper.v"
#    "E:/npart/KRD/project_tcl/ZCU111/fee_configurator_sim_test/fee_cfg_sim_tb.sv"
#    "E:/npart/KRD/proto_ip_code/fee_configurator/fee_config.vh"
#    "E:/npart/KRD/project_tcl/ZCU111/fee_configurator_sim_test/fee_cfg_sim_tb_behav.wcfg"
#
#*****************************************************************************************
...
if { [get_files fee_config.vh] == "" } {
  import_files -quiet -fileset sources_1 E:/npart/KRD/proto_ip_code/fee_configurator/fee_config.vh
}
if { [get_files fee_configrator.v] == "" } {
  import_files -quiet -fileset sources_1 E:/npart/KRD/proto_ip_code/fee_configurator/fee_configrator.v
}
...
# fee_configrator
  ...
  # Create ports
  set ACQUIRE_MODE_0 [ create_bd_port -dir O -from 0 -to 0 ACQUIRE_MODE_0 ]
  ...
  set FALLING_EDGE_THRESHOLD_0 [ create_bd_port -dir O -from 15 -to 0 FALLING_EDGE_THRESHOLD_0 ]
  set H_GAIN_BASELINE_0 [ create_bd_port -dir O -from 12 -to 0 H_GAIN_BASELINE_0 ]
  set L_GAIN_BASELINE_0 [ create_bd_port -dir O -from 15 -to 0 L_GAIN_BASELINE_0 ]
  set MAX_TRIGGER_LENGTH_0 [ create_bd_port -dir O -from 15 -to 0 MAX_TRIGGER_LENGTH_0 ]
  set POST_ACQUISITION_LENGTH_0 [ create_bd_port -dir O -from 1 -to 0 POST_ACQUISITION_LENGTH_0 ]
  set PRE_ACQUISITION_LENGTH_0 [ create_bd_port -dir O -from 1 -to 0 PRE_ACQUISITION_LENGTH_0 ]
  set RISING_EDGE_THRESHOLD_0 [ create_bd_port -dir O -from 15 -to 0 RISING_EDGE_THRESHOLD_0 ]
  set SET_CONFIG_0 [ create_bd_port -dir O -from 0 -to 0 SET_CONFIG_0 ]
  set STOP_0 [ create_bd_port -dir O -from 0 -to 0 STOP_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins fee_configrator_0/S_AXI]
  ...
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins axi_smc/aclk] [get_bd_pins fee_configrator_0/S_AXI_ACLK] [get_bd_pins rst_CLK_125M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net EXT_RESET_1 [get_bd_ports EXT_RESET] [get_bd_pins rst_CLK_125M/aux_reset_in]
  connect_bd_net -net fee_configrator_0_ACQUIRE_MODE [get_bd_ports ACQUIRE_MODE_0] [get_bd_pins fee_configrator_0/ACQUIRE_MODE]
  connect_bd_net -net fee_configrator_0_FALLING_EDGE_THRESHOLD [get_bd_ports FALLING_EDGE_THRESHOLD_0] [get_bd_pins fee_configrator_0/FALLING_EDGE_THRESHOLD]
  connect_bd_net -net fee_configrator_0_H_GAIN_BASELINE [get_bd_ports H_GAIN_BASELINE_0] [get_bd_pins fee_configrator_0/H_GAIN_BASELINE]
  connect_bd_net -net fee_configrator_0_L_GAIN_BASELINE [get_bd_ports L_GAIN_BASELINE_0] [get_bd_pins fee_configrator_0/L_GAIN_BASELINE]
  connect_bd_net -net fee_configrator_0_MAX_TRIGGER_LENGTH [get_bd_ports MAX_TRIGGER_LENGTH_0] [get_bd_pins fee_configrator_0/MAX_TRIGGER_LENGTH]
  connect_bd_net -net fee_configrator_0_POST_ACQUISITION_LENGTH [get_bd_ports POST_ACQUISITION_LENGTH_0] [get_bd_pins fee_configrator_0/POST_ACQUISITION_LENGTH]
  connect_bd_net -net fee_configrator_0_PRE_ACQUISITION_LENGTH [get_bd_ports PRE_ACQUISITION_LENGTH_0] [get_bd_pins fee_configrator_0/PRE_ACQUISITION_LENGTH]
  connect_bd_net -net fee_configrator_0_RISING_EDGE_THRESHOLD [get_bd_ports RISING_EDGE_THRESHOLD_0] [get_bd_pins fee_configrator_0/RISING_EDGE_THRESHOLD]
  connect_bd_net -net fee_configrator_0_SET_CONFIG [get_bd_ports SET_CONFIG_0] [get_bd_pins fee_configrator_0/SET_CONFIG]
  connect_bd_net -net fee_configrator_0_STOP [get_bd_ports STOP_0] [get_bd_pins fee_configrator_0/STOP]
  connect_bd_net -net rst_CLK_125M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins fee_configrator_0/S_AXI_ARESETN] [get_bd_pins rst_CLK_125M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x000400000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fee_configrator_0/S_AXI/reg0] SEG_fee_configrator_0_reg0
...
#  -string -flagsOSRD
preplace port CLK -pg 1 -lvl 0 -x 0 -y 70 -defaultsOSRD
preplace port EXT_RESET -pg 1 -lvl 0 -x 0 -y 110 -defaultsOSRD
preplace portBus ACQUIRE_MODE_0 -pg 1 -lvl 4 -x 1400 -y 260 -defaultsOSRD
preplace portBus FALLING_EDGE_THRESHOLD_0 -pg 1 -lvl 4 -x 1400 -y 300 -defaultsOSRD
preplace portBus H_GAIN_BASELINE_0 -pg 1 -lvl 4 -x 1400 -y 320 -defaultsOSRD
preplace portBus L_GAIN_BASELINE_0 -pg 1 -lvl 4 -x 1400 -y 340 -defaultsOSRD
preplace portBus MAX_TRIGGER_LENGTH_0 -pg 1 -lvl 4 -x 1400 -y 400 -defaultsOSRD
preplace portBus RISING_EDGE_THRESHOLD_0 -pg 1 -lvl 4 -x 1400 -y 280 -defaultsOSRD
preplace portBus SET_CONFIG_0 -pg 1 -lvl 4 -x 1400 -y 220 -defaultsOSRD
preplace portBus STOP_0 -pg 1 -lvl 4 -x 1400 -y 240 -defaultsOSRD
preplace portBus POST_ACQUISITION_LENGTH_0 -pg 1 -lvl 4 -x 1400 -y 380 -defaultsOSRD
preplace portBus PRE_ACQUISITION_LENGTH_0 -pg 1 -lvl 4 -x 1400 -y 360 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 290 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 790 -y 290 -defaultsOSRD
preplace inst rst_CLK_125M -pg 1 -lvl 1 -x 330 -y 110 -defaultsOSRD
preplace inst fee_configrator_0 -pg 1 -lvl 3 -x 1160 -y 310 -defaultsOSRD
preplace netloc CLK_1 1 0 3 20 380 650 380 930
preplace netloc rst_CLK_125M_peripheral_aresetn 1 1 2 640 370 940
preplace netloc fee_configrator_0_ACQUIRE_MODE 1 3 1 NJ 260
preplace netloc fee_configrator_0_FALLING_EDGE_THRESHOLD 1 3 1 NJ 300
preplace netloc fee_configrator_0_H_GAIN_BASELINE 1 3 1 NJ 320
preplace netloc fee_configrator_0_L_GAIN_BASELINE 1 3 1 NJ 340
preplace netloc fee_configrator_0_MAX_TRIGGER_LENGTH 1 3 1 NJ 400
preplace netloc fee_configrator_0_RISING_EDGE_THRESHOLD 1 3 1 NJ 280
preplace netloc fee_configrator_0_SET_CONFIG 1 3 1 NJ 220
preplace netloc fee_configrator_0_STOP 1 3 1 NJ 240
preplace netloc EXT_RESET_1 1 0 1 NJ 110
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 390 630
preplace netloc fee_configrator_0_POST_ACQUISITION_LENGTH 1 3 1 NJ 380
preplace netloc fee_configrator_0_PRE_ACQUISITION_LENGTH 1 3 1 NJ 360
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 270
preplace netloc axi_smc_M00_AXI 1 2 1 N 290
levelinfo -pg 1 0 330 790 1160 1400
pagesize -pg 1 -db -bbox -sgen -140 0 1710 460
"
}
