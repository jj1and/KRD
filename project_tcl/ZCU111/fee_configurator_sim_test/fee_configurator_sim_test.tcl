...
#
# fee_configurator_sim_test.tcl: Tcl script for re-creating project 'fee_configurator_sim_test'
#
# Generated by Vivado on Thu Oct 22 20:28:02 +0900 2020
...
#
# 1. This project restoration tcl script (fee_configurator_sim_test.tcl) that was generated.
#
...
#    "E:/KRD/project_tcl/ZCU111/fee_configurator_sim_test/fee_cfg_sim_wrapper.v"
#    "E:/KRD/project_tcl/ZCU111/fee_configurator_sim_test/fee_cfg_sim_tb.sv"
#    "E:/KRD/proto_ip_code/fee_configurator/fee_config.vh"
#    "E:/KRD/project_tcl/ZCU111/fee_configurator_sim_test/fee_cfg_sim_tb_behav.wcfg"
#
#*****************************************************************************************
...
set _xil_proj_name_ "fee_configurator_sim_test"
...
set script_file "fee_configurator_sim_test.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/fee_configurator_sim_test"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/fee_cfg_sim_wrapper.v"] \
]
...
set file "$origin_dir/fee_cfg_sim_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "fee_cfg_sim_wrapper" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/fee_cfg_sim_tb.sv"] \
 [file normalize "${origin_dir}/../../../proto_ip_code/fee_configurator/fee_config.vh"] \
 [file normalize "${origin_dir}/fee_cfg_sim_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/fee_cfg_sim_tb.sv"
set file [file normalize $file]
...
set file "$origin_dir/fee_cfg_sim_tb_behav.wcfg"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "fee_cfg_sim_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if { [get_files fee_config_wrapper.v] == "" } {
  import_files -quiet -fileset sources_1 E:/KRD/proto_ip_code/fee_configurator/fee_config_wrapper.v
}


# Proc to create BD fee_cfg_sim
proc cr_bd_fee_cfg_sim { parentCell } {
...
# fee_config_wrapper
  ...
  set CH0_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH0_CONTROL_0 ]

  set CH10_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH10_CONTROL_0 ]

  set CH11_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH11_CONTROL_0 ]

  set CH12_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH12_CONTROL_0 ]

  set CH13_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH13_CONTROL_0 ]

  set CH14_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH14_CONTROL_0 ]

  set CH15_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH15_CONTROL_0 ]

  set CH1_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH1_CONTROL_0 ]

  set CH2_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH2_CONTROL_0 ]

  set CH3_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH3_CONTROL_0 ]

  set CH4_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH4_CONTROL_0 ]

  set CH5_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH5_CONTROL_0 ]

  set CH6_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH6_CONTROL_0 ]

  set CH7_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH7_CONTROL_0 ]

  set CH8_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH8_CONTROL_0 ]

  set CH9_CONTROL_0 [ create_bd_intf_port -mode Master -vlnv awa.tohoku.ac.jp:mogura2:trigger_control_rtl:1.0 CH9_CONTROL_0 ]
  ...
  set block_name fee_config_wrapper
  set block_cell_name fee_config_wrapper_0
  if { [catch {set fee_config_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fee_config_wrapper_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins fee_config_wrapper_0/S_AXI]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH0_CONTROL [get_bd_intf_ports CH0_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH0_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH10_CONTROL [get_bd_intf_ports CH10_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH10_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH11_CONTROL [get_bd_intf_ports CH11_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH11_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH12_CONTROL [get_bd_intf_ports CH12_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH12_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH13_CONTROL [get_bd_intf_ports CH13_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH13_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH14_CONTROL [get_bd_intf_ports CH14_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH14_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH15_CONTROL [get_bd_intf_ports CH15_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH15_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH1_CONTROL [get_bd_intf_ports CH1_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH1_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH2_CONTROL [get_bd_intf_ports CH2_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH2_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH3_CONTROL [get_bd_intf_ports CH3_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH3_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH4_CONTROL [get_bd_intf_ports CH4_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH4_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH5_CONTROL [get_bd_intf_ports CH5_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH5_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH6_CONTROL [get_bd_intf_ports CH6_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH6_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH7_CONTROL [get_bd_intf_ports CH7_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH7_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH8_CONTROL [get_bd_intf_ports CH8_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH8_CONTROL]
  connect_bd_intf_net -intf_net fee_config_wrapper_0_CH9_CONTROL [get_bd_intf_ports CH9_CONTROL_0] [get_bd_intf_pins fee_config_wrapper_0/CH9_CONTROL]
  ...
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins axi_smc/aclk] [get_bd_pins fee_config_wrapper_0/S_AXI_ACLK] [get_bd_pins rst_CLK_125M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net EXT_RESET_1 [get_bd_ports EXT_RESET] [get_bd_pins rst_CLK_125M/aux_reset_in]
  connect_bd_net -net rst_CLK_125M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins fee_config_wrapper_0/S_AXI_ARESETN] [get_bd_pins rst_CLK_125M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_CLK_125M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x000400000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fee_config_wrapper_0/S_AXI/reg0] SEG_fee_config_wrapper_0_reg0
...
# End of cr_bd_fee_cfg_sim()
cr_bd_fee_cfg_sim ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files fee_cfg_sim.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files fee_cfg_sim.bd ] 
set_property IS_ENABLED "1" [get_files fee_cfg_sim.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files fee_cfg_sim.bd ] 
set_property IS_LOCKED "0" [get_files fee_cfg_sim.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files fee_cfg_sim.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files fee_cfg_sim.bd ] 
set_property PFM_NAME "" [get_files fee_cfg_sim.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files fee_cfg_sim.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files fee_cfg_sim.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files fee_cfg_sim.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files fee_cfg_sim.bd ] 
set_property USED_IN_SIMULATION "1" [get_files fee_cfg_sim.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files fee_cfg_sim.bd ] 
