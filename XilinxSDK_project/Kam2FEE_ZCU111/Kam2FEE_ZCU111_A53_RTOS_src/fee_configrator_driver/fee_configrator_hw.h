...
#define FEE_CONFIGRATOR_NUM_INSTANCES 1
#define FEE_CONFIGRATOR_0_DEVICE_ID 0
#define XPAR_FEE_CONFIGRATOR_0_BASEADDR XPAR_HARDWARE_TRIGGER_BLOCKS_FEE_CONFIG_WRAPPER_0_BASEADDR
...
#define CONTROL_STATE_MASK 0x00C00000
#define RUN_STATE 0x00000000
#define CONFIG_STATE 0x008000000
#define STOP_STATE 0x00400000
#define CONFIG_STOP_STATE 0x00C00000

#define ACQUIRE_MODE_MASK 0x00300000
#define NORMAL_MODE 0x00000000
#define COMBINED_MODE 0x00100000
#define DSP_NORMAL_MODE 0x00200000
#define DSP_COMBINED_MODE 0x00300000
...
#define FEEConfig_indent(RegOffset) ((((RegOffset) >= CONTROL_ADDR_OFFSET) && ((RegOffset) <= BASELINE_ADDR_OFFSET + (CHANNEL_NUM - 1) * CHANNEL_OFFSET)) ? "\t" : "")
