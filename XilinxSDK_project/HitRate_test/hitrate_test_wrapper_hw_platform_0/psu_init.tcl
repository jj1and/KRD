...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0034 0xFE7FEDEF 0x7E73AC6C
		# : UPDATE FB_DIV
    ...
    mask_write 0XFF5E0030 0x00717F00 0x00012800
		# : BY PASS PLL
		# Register : RPLL_CTRL @ 0XFF5E0030</p>
    ...
    mask_write 0XFD1A0024 0xFE7FEDEF 0x7E60EC6C
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A0020 0x00717F00 0x00013000
		# : BY PASS PLL
		# Register : APLL_CTRL @ 0XFD1A0020</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF18030C 0x00000003 0x00000001
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01023202
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x0D0E1A0E
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x061C0C06
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180098 0x000000FE 0x00000008
    ...
    mask_write 0XFF18009C 0x000000FE 0x00000008
    ...
    mask_write 0XFF1800A0 0x000000FE 0x00000008
    ...
    mask_write 0XFF1800A4 0x000000FE 0x00000008
    ...
    mask_write 0XFF1800A8 0x000000FE 0x00000008
    ...
    mask_write 0XFF1800AC 0x000000FE 0x00000008
    ...
    mask_write 0XFF1800B0 0x000000FE 0x00000008
    ...
    mask_write 0XFF180204 0xE47FFFBF 0x00000002
    ...
    mask_write 0XFF180208 0x000FFFFC 0x00002084
