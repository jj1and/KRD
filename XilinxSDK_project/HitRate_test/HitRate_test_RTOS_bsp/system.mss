...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = peripheral_ctrl_block_axi_iic_0_CDCI6214_Bank88
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = peripheral_ctrl_block_axi_iic_0_SFP1_Bank89
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = peripheral_ctrl_block_axi_iic_0_SFP2_Bank90
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = peripheral_ctrl_block_axi_quad_spi_0_LADC_bank87
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = peripheral_ctrl_block_axi_quad_spi_1_BASEDAC_bank84
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = peripheral_ctrl_block_system_management_wiz_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = dummy_receiver_block_axi_gpio_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = dummy_receiver_block_axi_gpio_2
END
