...
module dsp_blr_tb (
  ...
  wire [1-1:0] dsp_m_axis_tvalid_net;
  wire [1-1:0] h_m_axis_tvalid_net;
  wire [160-1:0] dsp_m_axis_tdata_net;
  wire [1-1:0] l_m_axis_tvalid_net;
  wire [32-1:0] l_m_axis_tdata_net;
  wire [128-1:0] h_m_axis_tdata_net;
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(128),
    .inputFile("dsp_blr_h_s_axis_tdata.dat"),
    .periodMultiplier(1)
  )
  h_s_axis_tdata_driver (
    .clk(clk_net),
    .o(h_s_axis_tdata_net)
  );
  xltbsource #(
    .o_arith(`xlUnsigned),
    .o_bin_pt(0),
    .o_width(1),
    .inputFile("dsp_blr_h_s_axis_tvalid.dat"),
    .periodMultiplier(1)
  )
  h_s_axis_tvalid_driver (
    .clk(clk_net),
    .o(h_s_axis_tvalid_net)
  );
  xltbsource #(
    .o_arith(`xlUnsigned),
    .o_bin_pt(0),
    .o_width(32),
    .inputFile("dsp_blr_l_s_axis_tdata.dat"),
    .periodMultiplier(1)
  )
  l_s_axis_tdata_driver (
    .clk(clk_net),
    .o(l_s_axis_tdata_net)
  );
  xltbsource #(
    .o_arith(`xlUnsigned),
    .o_bin_pt(0),
    .o_width(1),
    .inputFile("dsp_blr_l_s_axis_tvalid.dat"),
    .periodMultiplier(1)
  )
  l_s_axis_tvalid_driver (
    .clk(clk_net),
    .o(l_s_axis_tvalid_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(160),
    .inputFile("dsp_blr_dsp_m_axis_tdata.dat"),
    .periodMultiplier(1)
  )
  dsp_m_axis_tdata_load (
    .i(dsp_m_axis_tdata_net),
    .clk(clk_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(1),
    .inputFile("dsp_blr_dsp_m_axis_tvalid.dat"),
    .periodMultiplier(1)
  )
  dsp_m_axis_tvalid_load (
    .i(dsp_m_axis_tvalid_net),
    .clk(clk_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(128),
    .inputFile("dsp_blr_h_m_axis_tdata.dat"),
    .periodMultiplier(1)
  )
  h_m_axis_tdata_load (
    .i(h_m_axis_tdata_net),
    .clk(clk_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(1),
    .inputFile("dsp_blr_h_m_axis_tvalid.dat"),
    .periodMultiplier(1)
  )
  h_m_axis_tvalid_load (
    .i(h_m_axis_tvalid_net),
    .clk(clk_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(32),
    .inputFile("dsp_blr_l_m_axis_tdata.dat"),
    .periodMultiplier(1)
  )
  l_m_axis_tdata_load (
    .i(l_m_axis_tdata_net),
    .clk(clk_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(1),
    .inputFile("dsp_blr_l_m_axis_tvalid.dat"),
    .periodMultiplier(1)
  )
  l_m_axis_tvalid_load (
    .i(l_m_axis_tvalid_net),
    .clk(clk_net)
  );
  dsp_blr_bd_wrapper sysgen_dut (
    .h_s_axis_tdata(h_s_axis_tdata_net),
    .h_s_axis_tvalid(h_s_axis_tvalid_net),
    .l_s_axis_tdata(l_s_axis_tdata_net),
    .l_s_axis_tvalid(l_s_axis_tvalid_net),
    .clk(clk_net),
    .dsp_m_axis_tdata(dsp_m_axis_tdata_net),
    .dsp_m_axis_tvalid(dsp_m_axis_tvalid_net),
    .h_m_axis_tdata(h_m_axis_tdata_net),
    .h_m_axis_tvalid(h_m_axis_tvalid_net),
    .l_m_axis_tdata(l_m_axis_tdata_net),
    .l_m_axis_tvalid(l_m_axis_tvalid_net)
  );
endmodule
